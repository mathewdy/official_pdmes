...
if($phase8_final_rating_islamic_values >= 75){
    ...
    if($run_insert_learners_info){
        ...
        VALUES ('$lrn', '$mother_tongue','$term1_phase2_mother_tongue', '$term2_phase1', '$term2_phase1_remarks','$dateCreated', '$dateUpdated')";
        ...
        VALUES ('$lrn', '$filipino','$term2_phase1_filipino', '$term2_phase1', '$term2_phase1_remarks','$dateCreated', '$dateUpdated')";
        ...
        VALUES ('$lrn', '$english','$term2_phase1_english', '$term2_phase1', '$term2_phase1_remarks','$dateCreated', '$dateUpdated')";
        ...
        $insert_student_grades_term2_phase1_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
        VALUES ('$lrn', '$math','$term2_phase1_mathematics', '$term2_phase1', '$term2_phase1_remarks','$dateCreated', '$dateUpdated')";
        ...
        VALUES ('$lrn', '$science','$term2_phase1_science', '$term2_phase1', '$term2_phase1_remarks','$dateCreated', '$dateUpdated')";
        ...
        VALUES ('$lrn', '$AP','$term2_phase1_araling_panlipunan', '$term2_phase1', '$term2_phase1_remarks','$dateCreated', '$dateUpdated')";
        ...
        VALUES ('$lrn', '$epp_tle','$term2_phase1_epp_tle', '$term2_phase1', '$term2_phase1_remarks','$dateCreated', '$dateUpdated')";
        ...
        $insert_term2_phase1_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
        VALUES ('$lrn', '$mapeh','$term2_phase1_average_of_mapeh', '$term2_phase1', '$term2_phase1_remarks','$dateCreated', '$dateUpdated')";
        ...
        //insert term2 phase 1 mapeh
        $insert_term2_phase1_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
        VALUES ('$lrn', '$music','$term2_phase1_music', '$term2_phase1', '$term2_phase1_remarks','$dateCreated', '$dateUpdated')";
        ...
        $insert_term2_phase1_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
        VALUES ('$lrn', '$arts','$term2_phase1_arts', '$term2_phase1', '$term2_phase1_remarks','$dateCreated', '$dateUpdated')";
        ...
        $insert_term2_phase1_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
        VALUES ('$lrn', '$PE','$term2_phase1_pe', '$term2_phase1', '$term2_phase1_remarks','$dateCreated', '$dateUpdated')";
        ...
        $insert_term2_phase1_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
        VALUES ('$lrn', '$health','$term2_phase1_health', '$term2_phase1', '$term2_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term2_phase1_health = mysqli_query($conn,$insert_term2_phase1_health);
        if($run_student_grades_term2_phase1_health){
            echo"added insert_term2_phase1_health";
        }
        else{
            echo"error term2 phase 1 health". $conn->error; 
        }
        ...
        $run_student_grades_term2_phase1_esp = mysqli_query($conn,$insert_student_grades_term2_phase1_esp);
            ...
            if($run_student_grades_term2_phase1_esp){
                echo"esp term 2 phase 1 added ";
            }
            else{
                echo"esp term 2 phgase 1 error". $conn->error;
            }
        ...
        $run_phase1_term2_general_average = mysqli_query($conn,$insert_phase1_term2_general_average);
         ...
         //phase 1 term 3 
                ...
                //insert term3 phase 1 grades MT
        ...
        VALUES ('$lrn', '$mother_tongue','$term1_phase2_mother_tongue', '$term3_phase1', '$term3_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term3_phase1_mother_tongue = mysqli_query($conn,$insert_student_grades_term3_phase1_mother_tongue);
        if($run_student_grades_3_phase1_mother_tongue){
            echo "added insert_student_grades_term3_phase1_mother_tongue ";
        }else{
            echo "error insert_student_grades_term3_phase1_mother_tongue". $conn->error;
        }

        //insert term3 phase 1 Filipino
        ...
        VALUES ('$lrn', '$filipino','$term3_phase1_filipino', '$term3_phase1', '$term3_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term3_phase1_filipino = mysqli_query($conn,$insert_student_grades_term3_phase1_filipino);
        if($run_student_grades_term3_phase1_filipino){
            echo "added insert_student_grades_term3_phase1_filipino ";
        }else{
            echo "error insert_student_grades_term3_phase1_filipino". $conn->error;
        }

        //insert term3 phase 1 English
        ...
        VALUES ('$lrn', '$english','$term3_phase1_english', '$term3_phase1', '$term3_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term3_phase1_english = mysqli_query($conn,$insert_student_grades_term3_phase1_english);
        if($run_student_grades_term3_phase1_english){
            echo "added insert_student_grades_term3_phase1_english ";
        }else{
            echo "error insert_student_grades_term3_phase1_english". $conn->error;
        }

        //insert term3 phase 1 math
        $insert_student_grades_term3_phase1_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
        VALUES ('$lrn', '$math','$term3_phase1_mathematics', '$term3_phase1', '$term3_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term3_phase1_mathematics = mysqli_query($conn,$insert_student_grades_term3_phase1_mathematics);
        if($run_student_grades_term3_phase1_mathematics){
            echo "added insert_student_grades_term3_phase1_mathematics ";
        }else{
            echo "error insert_student_grades_term3_phase1_mathematics". $conn->error;
        }

        //insert term3 phase 1 science
        ...
        VALUES ('$lrn', '$science','$term3_phase1_science', '$term3_phase1', '$term3_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term3_phase1_science = mysqli_query($conn,$insert_student_grades_term3_phase1_science);
        if($run_student_grades_term3_phase1_science){
            echo "added insert_student_grades_term3_phase1_science ";
        }else{
            echo "error insert_student_grades_term3_phase1_science". $conn->error;
        }


        //insert term3 phase 1 AP
        ...
        VALUES ('$lrn', '$AP','$term3_phase1_araling_panlipunan', '$term3_phase1', '$term3_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term3_phase1_AP = mysqli_query($conn,$insert_student_grades_term3_phase1_AP);
        if($run_student_grades_term3_phase1_AP){
            echo "added insert_student_grades_term3_phase1_AP ";
        }else{
            echo "error insert_student_grades_term3_phase1_AP". $conn->error;
        }


        //insert term3 phase 1 epp tle
        ...
        VALUES ('$lrn', '$epp_tle','$term3_phase1_epp_tle', '$term3_phase1', '$term3_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term3_phase1_epp_tle = mysqli_query($conn,$insert_student_grades_term3_phase1_epp_tle);
        if($run_student_grades_term3_phase1_epp_tle){
            echo "added insert_student_grades_term3_phase1_epp_tle ";
        }else{
            echo "error insert_student_grades_term3_phase1_epp_tle". $conn->error;
        }

        //insert term3 phase 1 mapeh
        $insert_term3_phase1_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
        VALUES ('$lrn', '$mapeh','$term3_phase1_average_of_mapeh', '$term3_phase1', '$term3_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term3_phase1_mapeh = mysqli_query($conn,$run_student_grades_term3_phase1_mapeh);
        if($run_student_grades_term3_phase1_epp_tle){
            echo "added insert_term3_phase1_average_of_mapeh ";
        }else{
            echo "error insert_term3_phase1_average_of_mapeh". $conn->error;
        }

        
        //insert term3 phase 1 mapeh
        $insert_term3_phase1_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
        VALUES ('$lrn', '$music','$term3_phase1_music', '$term3_phase1', '$term3_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term3_phase1_music = mysqli_query($conn,$insert_term3_phase1_music);
        if($run_student_grades_term3_phase1_music){
            echo "added insert_term3_phase1_music ";
        }else{
            echo "error insert_term3_phase1_music". $conn->error;
        }

        //insert term3 phase 1 arts
$insert_term3_phase1_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
VALUES ('$lrn', '$arts','$term3_phase1_arts', '$term3_phase1', '$term3_phase1_remarks','$dateCreated', '$dateUpdated')";
$run_student_grades_term3_phase1_arts = mysqli_query($conn,$insert_term3_phase1_arts);
if($run_student_grades_term3_phase1_arts){
    echo "added insert_term3_phase1_arts ";
}else{
    echo "error insert_term3_phase1_arts". $conn->error;
}

//insert term3 phase 1 PE
$insert_term3_phase1_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
VALUES ('$lrn', '$PE','$term3_phase1_pe', '$term3_phase1', '$term3_phase1_remarks','$dateCreated', '$dateUpdated')";
$run_student_grades_term3_phase1_pe = mysqli_query($conn,$insert_term3_phase1_PE);
if($run_student_grades_term3_phase1_pe){
    echo "added insert_term3_phase1_PE ";
}else{
    echo "error insert_term3_phase1_PE". 
    $conn->error;
}

$insert_term3_phase1_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
VALUES ('$lrn', '$health','$term3_phase1_health', '$term3_phase1', '$term3_phase1_remarks','$dateCreated', '$dateUpdated')";
$run_student_grades_term3_phase1_health = mysqli_query($conn,$insert_term3_phase1_health);
if($run_student_grades_term3_phase1_health){
    echo"added insert_term3_phase1_health";
}
else{
    echo"error term3 phase 1 health". $conn->error; 
}
...
$run_student_grades_term3_phase1_esp = mysqli_query($conn,$insert_student_grades_term3_phase1_esp);
    ...
    if($run_student_grades_term3_phase1_esp){
        echo"esp term 3 phase 1 added ";
    }
    else{
        echo"esp term 3 phgase 1 error". $conn->error;
    }
    ...
    if($run_student_grades_term3_phase1_islamic){
        ...
        //genral average of phase 1 term 3
   ...
   //insert term4 phase 1 grades MT
        ...
        VALUES ('$lrn', '$mother_tongue','$term1_phase2_mother_tongue', '$term4_phase1', '$term4_phase1_remarks','$dateCreated', '$dateUpdated')";
         $run_student_grades_term4_phase1_mother_tongue = mysqli_query($conn,$insert_student_grades_term4_phase1_mother_tongue);
         if($run_student_grades_4_phase1_mother_tongue){
                    echo "added insert_student_grades_term4_phase1_mother_tongue ";
                }else{
                    echo "error insert_student_grades_term4_phase1_mother_tongue". $conn->error;
                }
        
                //insert term4 phase 1 Filipino
        ...
        VALUES ('$lrn', '$filipino','$term4_phase1_filipino', '$term4_phase1', '$term4_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term4_phase1_filipino = mysqli_query($conn,$insert_student_grades_term4_phase1_filipino);
        if($run_student_grades_term4_phase1_filipino){
                 echo "added insert_student_grades_term4_phase1_filipino ";
                }
                else{
                 echo "error insert_student_grades_term4_phase1_filipino". $conn->error;
                }
        
        //insert term4 phase 1 English
        ...
        VALUES ('$lrn', '$english','$term4_phase1_english', '$term4_phase1', '$term4_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term4_phase1_english = mysqli_query($conn,$insert_student_grades_term4_phase1_english);
        if($run_student_grades_term4_phase1_english){
        echo "added insert_student_grades_term4_phase1_english ";
                }
            else{
                echo "error insert_student_grades_term4_phase1_english". $conn->error;
                }
        
        //insert term4 phase 1 math
        $insert_student_grades_term4_phase1_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
        VALUES ('$lrn', '$math','$term4_phase1_mathematics', '$term4_phase1', '$term4_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term4_phase1_mathematics = mysqli_query($conn,$insert_student_grades_term4_phase1_mathematics);
        if($run_student_grades_term4_phase1_mathematics){
            echo "added insert_student_grades_term4_phase1_mathematics ";
                }
            else{
                 echo "error insert_student_grades_term4_phase1_mathematics". $conn->error;
                }
        
        //insert term4 phase 1 science
        ...
        VALUES ('$lrn', '$science','$term4_phase1_science', '$term4_phase1', '$term4_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term4_phase1_science = mysqli_query($conn,$insert_student_grades_term4_phase1_science);
            if($run_student_grades_term4_phase1_science){
                 echo "added insert_student_grades_term4_phase1_science ";
                }
                else{
                echo "error insert_student_grades_term4_phase1_science". $conn->error;
                }
        
        
        //insert term4 phase 1 AP
        ...
        VALUES ('$lrn', '$AP','$term4_phase1_araling_panlipunan', '$term4_phase1', '$term4_phase1_remarks','$dateCreated', '$dateUpdated')";
         $run_student_grades_term4_phase1_AP = mysqli_query($conn,$insert_student_grades_term4_phase1_AP);
            if($run_student_grades_term4_phase1_AP){
                 echo "added insert_student_grades_term4_phase1_AP ";
                }
            else{
                  echo "error insert_student_grades_term4_phase1_AP". $conn->error;
             }
        
        
         //insert term4 phase 1 epp tle
        ...
        VALUES ('$lrn', '$epp_tle','$term4_phase1_epp_tle', '$term4_phase1', '$term4_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term4_phase1_epp_tle = mysqli_query($conn,$insert_student_grades_term4_phase1_epp_tle);
            if($run_student_grades_term4_phase1_epp_tle){
                echo "added insert_student_grades_term4_phase1_epp_tle ";
                }
            else{
              echo "error insert_student_grades_term4_phase1_epp_tle". $conn->error;
                }
        
        //insert term4 phase 1 mapeh
        $insert_term4_phase1_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
        VALUES ('$lrn', '$mapeh','$term4_phase1_average_of_mapeh', '$term4_phase1', '$term4_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term4_phase1_mapeh = mysqli_query($conn,$run_student_grades_term4_phase1_mapeh);
        if($run_student_grades_term4_phase1_epp_tle){
            echo "added insert_term4_phase1_average_of_mapeh ";
            }
            else{
             echo "error insert_term4_phase1_average_of_mapeh". $conn->error;
                }
        
                
         //insert term4 phase 1 mapeh
        $insert_term4_phase1_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
        VALUES ('$lrn', '$music','$term4_phase1_music', '$term4_phase1', '$term4_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term4_phase1_music = mysqli_query($conn,$insert_term4_phase1_music);
            if($run_student_grades_term4_phase1_music){
                 echo "added insert_term4_phase1_music ";
              }
              else{
                 echo "error insert_term4_phase1_music". $conn->error;
                }
        
          //insert term4 phase 1 arts
        $insert_term4_phase1_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
        VALUES ('$lrn', '$arts','$term4_phase1_arts', '$term4_phase1', '$term4_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term4_phase1_arts = mysqli_query($conn,$insert_term4_phase1_arts);
        if($run_student_grades_term4_phase1_arts){
            echo "added insert_term4_phase1_arts ";
        }else{
            echo "error insert_term4_phase1_arts". $conn->error;
        }
        
        //insert term4 phase 1 PE
        $insert_term4_phase1_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
        VALUES ('$lrn', '$PE','$term4_phase1_pe', '$term4_phase1', '$term4_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term4_phase1_pe = mysqli_query($conn,$insert_term4_phase1_PE);
        if($run_student_grades_term4_phase1_pe){
            echo "added insert_term4_phase1_PE ";
        }else{
            echo "error insert_term4_phase1_PE". 
            $conn->error;
        }
        
        $insert_term4_phase1_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
        VALUES ('$lrn', '$health','$term4_phase1_health', '$term4_phase1', '$term4_phase1_remarks','$dateCreated', '$dateUpdated')";
        $run_student_grades_term4_phase1_health = mysqli_query($conn,$insert_term4_phase1_health);
        if($run_student_grades_term4_phase1_health){
            echo"added insert_term4_phase1_health";
        }
        else{
            echo"error term4 phase 1 health". $conn->error; 
        }
        ...
        $run_student_grades_term4_phase1_esp = mysqli_query($conn,$insert_student_grades_term4_phase1_esp);
            ...
            if($run_student_grades_term4_phase1_esp){
                echo"esp term 4 phase 1 added ";
            }
            else{
                echo"esp term 4 phgase 1 error". $conn->error;
            }
            ...
            if($run_student_grades_term4_phase1_islamic){
                 echo  "added term islamic" . '<br>';
                  ...
                  echo "error term4_phase1 islamic" . '<br>';
                    ...
                    // general average of phase 1 term 4 
...
$insert_student_final_ratings_filipino = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
            ...
            VALUES ('$lrn', '$english','$phase1_final_rating_english', '$term5', '$phase1', '$phase1_final_rating_english', '$dateCreated' , '$dateUpdated')";
            ...
            VALUES ('$lrn', '$math','$phase1_final_rating_math', '$term5', '$phase1', '$phase1_final_rating_math', '$dateCreated' , '$dateUpdated')";
            ...
            VALUES ('$lrn', '$science','$phase1_final_rating_science', '$term5', '$phase1', '$phase1_final_rating_science', '$dateCreated' , '$dateUpdated')";
            ...
            VALUES ('$lrn', '$AP','$phase1_final_rating_AP', '$term5', '$phase1', '$phase1_final_rating_AP', '$dateCreated' , '$dateUpdated')";
            ...
            VALUES ('$lrn', '$epp_tle','$phase1_final_rating_epp_tle', '$term5', '$phase1', '$phase1_final_rating_epp_tle', '$dateCreated' , '$dateUpdated')";
            ...
            VALUES ('$lrn', '$mapeh','$phase1_final_rating_mapeh', '$term5', '$phase1', '$phase1_final_rating_mapeh', '$dateCreated' , '$dateUpdated')";
            ...
            VALUES ('$lrn', '$music','$phase1_final_rating_music', '$term5', '$phase1', '$phase1_final_rating_music', '$dateCreated' , '$dateUpdated')";
            ...
            VALUES ('$lrn', '$arts','$phase1_final_rating_arts', '$term5', '$phase1', '$phase1_final_rating_arts', '$dateCreated' , '$dateUpdated')";
            ...
            VALUES ('$lrn', '$PE','$phase1_final_rating_PE', '$term5', '$phase1', '$phase1_final_rating_PE', '$dateCreated' , '$dateUpdated')";
            ...
            VALUES ('$lrn', '$health','$phase1_final_rating_health', '$term5', '$phase1', '$phase1_final_rating_health', '$dateCreated' , '$dateUpdated')";
            ...
            VALUES ('$lrn', '$esp', '$phase1_final_rating_esp','$term5', '$phase1', '$phase1_final_rating_esp', '$dateCreated' , '$dateUpdated')";
            ...
            VALUES ('$lrn', '$arabic_language','$phase1_final_rating_arabic_language', '$term5', '$phase1', '$phase1_final_rating_arabic_language', '$dateCreated' , '$dateUpdated')";
            ...
            $insert_student_final_ratings_arabic = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
            VALUES ('$lrn', '$islamic_values','$phase1_final_rating_islamic_values', '$term5', '$phase1', '$phase1_final_rating_islamic_values_outpu', '$dateCreated' , '$dateUpdated')";
            $run_student_final_ratings_arabic = mysqli_query($conn,$insert_student_final_ratings_arabic);
            ...
            if($phase2_run_scholastic_records){
                ...
                if($run_student_grades_term1_phase2_islamic){
                     echo  "added term islamic" . '<br>';
                      ...
                      echo "error term1_phase2 islamic" . '<br>';
                        ...
                        //general average
                    $insert_phase2_term1_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn', '$phase2_term1_general_average', '$term1_phase2','$phase2_remarks','$dateCreated', '$dateUpdated')";
                ...
                VALUES ('$lrn', '$mother_tongue','$term1_phase2_mother_tongue', '$term2_phase2', '$term2_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase2_mother_tongue = mysqli_query($conn,$insert_student_grades_term2_phase2_mother_tongue);
                if($run_student_grades_term2_phase2_mother_tongue){
                echo "added insert_student_grades_term2_phase2_mother_tongue ";
                }else{
                echo "error insert_student_grades_term2_phase2_mother_tongue". $conn->error;
                }
                ...
                VALUES ('$lrn', '$filipino','$term2_phase2_filipino', '$term2_phase2', '$term2_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase2_filipino = mysqli_query($conn,$insert_student_grades_term2_phase2_filipino);
                if($run_student_grades_term2_phase2_filipino){
                echo "added insert_student_grades_term2_phase2_filipino ";
                }else{
                echo "error insert_student_grades_term2_phase2_filipino". $conn->error;
                }
                ...
                VALUES ('$lrn', '$english','$term2_phase2_english', '$term2_phase2', '$term2_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase2_english = mysqli_query($conn,$insert_student_grades_term2_phase2_english);
                if($run_student_grades_term2_phase2_english){
                echo "added insert_student_grades_term2_phase2_english ";
                }else{
                echo "error insert_student_grades_term2_phase2_english". $conn->error;
                }
                
                //insert term2 phase 1 math
                $insert_student_grades_term2_phase2_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$math','$term2_phase2_mathematics', '$term2_phase2', '$term2_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase2_mathematics = mysqli_query($conn,$insert_student_grades_term2_phase2_mathematics);
                if($run_student_grades_term2_phase2_mathematics){
                echo "added insert_student_grades_term1_phase2_mathematics ";
                }else{
                echo "error insert_student_grades_term1_phase2_mathematics". $conn->error;
                }
                ...
                VALUES ('$lrn', '$science','$term2_phase2_science', '$term2_phase2', '$term2_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase2_science = mysqli_query($conn,$insert_student_grades_term2_phase2_science);
                if($run_student_grades_term2_phase2_science){
                echo "added insert_student_grades_term2_phase2_science ";
                }else{
                echo "error insert_student_grades_term2_phase2_science". $conn->error;
                }
                ...
                VALUES ('$lrn', '$AP','$term2_phase2_araling_panlipunan', '$term2_phase2', '$term2_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase2_AP = mysqli_query($conn,$insert_student_grades_term2_phase2_AP);
                if($run_student_grades_term2_phase2_AP){
                echo "added insert_student_grades_term2_phase2_AP ";
                }else{
                echo "error insert_student_grades_term2_phase2_AP". $conn->error;
                }
                ...
                VALUES ('$lrn', '$epp_tle','$term2_phase2_epp_tle', '$term2_phase2', '$term2_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase2_epp_tle = mysqli_query($conn,$insert_student_grades_term2_phase2_epp_tle);
                if($run_student_grades_term2_phase2_epp_tle){
                echo "added insert_student_grades_term2_phase2_epp_tle ";
                }else{
                echo "error insert_student_grades_term2_phase2_epp_tle". $conn->error;
                }
                
                //insert term2 phase 1 mapeh
                $insert_term2_phase2_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$mapeh','$term2_phase2_average_of_mapeh', '$term2_phase2', '$term2_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase2_mapeh = mysqli_query($conn,$run_student_grades_term2_phase2_mapeh);
                if($run_student_grades_term2_phase2_epp_tle){
                echo "added insert_term2_phase2_average_of_mapeh ";
                }else{
                echo "error insert_term2_phase2_average_of_mapeh". $conn->error;
                }
                
                
                //insert term2 phase 1 mapeh
                $insert_term2_phase2_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$music','$term2_phase2_music', '$term2_phase2', '$term2_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase2_music = mysqli_query($conn,$insert_term2_phase2_music);
                if($run_student_grades_term2_phase2_music){
                echo "added insert_term2_phase2_music ";
                }else{
                echo "error insert_term2_phase2_music". $conn->error;
                }
                
                //insert term2 phase 1 arts
                $insert_term2_phase2_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$arts','$term2_phase2_arts', '$term2_phase2', '$term2_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase2_arts = mysqli_query($conn,$insert_term2_phase2_arts);
                if($run_student_grades_term2_phase2_arts){
                echo "added insert_term2_phase2_arts ";
                }else{
                echo "error insert_term2_phase2_arts". $conn->error;
                }
                
                //insert term2 phase 1 PE
                $insert_term2_phase2_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$PE','$term2_phase2_pe', '$term2_phase2', '$term2_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase2_pe = mysqli_query($conn,$insert_term2_phase2_PE);
                if($run_student_grades_term2_phase2_pe){
                echo "added insert_term2_phase2_PE ";
                }else{
                echo "error insert_term2_phase2_PE". 
                $conn->error;
                }
                
                $insert_term2_phase2_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$health','$term2_phase2_health', '$term2_phase2', '$term2_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase2_health = mysqli_query($conn,$insert_term2_phase2_health);
                if($run_student_grades_term2_phase2_health){
                echo"added insert_term2_phase2_health";
                }
                else{
                echo"error term2 phase 1 health". $conn->error; 
                }
                ...
                if($run_student_grades_term2_phase2_islamic){
                     echo  "added term islamic" . '<br>';
                      ...
                      echo "error term2_phase2 islamic" . '<br>';
                        ...
                        // general average of term 2
                $insert_phase2_term2_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase2_term2_general_average', '$term1_phase2','$term1_phase2_remarks', '$dateCreated','$dateUpdated')";
                $run_phase2_term2_general_average = mysqli_query($conn,$insert_phase2_term2_general_average);
                
                 if($run_phase2_term2_general_average){
                            echo "added student averages term2";
                 }else{
                      echo "error student averages term2";
                     }
                ...
                VALUES ('$lrn', '$mother_tongue','$term1_phase2_mother_tongue', '$term3_phase2', '$term3_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase2_mother_tongue = mysqli_query($conn,$insert_student_grades_term3_phase2_mother_tongue);
                if($run_student_grades_3_phase2_mother_tongue){
                echo "added insert_student_grades_term3_phase2_mother_tongue ";
                }else{
                echo "error insert_student_grades_term3_phase2_mother_tongue". $conn->error;
                }
                ...
                VALUES ('$lrn', '$filipino','$term3_phase2_filipino', '$term3_phase2', '$term3_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase2_filipino = mysqli_query($conn,$insert_student_grades_term3_phase2_filipino);
                if($run_student_grades_term3_phase2_filipino){
                echo "added insert_student_grades_term3_phase2_filipino ";
                }else{
                echo "error insert_student_grades_term3_phase2_filipino". $conn->error;
                }
                ...
                VALUES ('$lrn', '$english','$term3_phase2_english', '$term3_phase2', '$term3_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase2_english = mysqli_query($conn,$insert_student_grades_term3_phase2_english);
                if($run_student_grades_term3_phase2_english){
                echo "added insert_student_grades_term3_phase2_english ";
                }else{
                echo "error insert_student_grades_term3_phase2_english". $conn->error;
                }
                
                //insert term3 phase 1 math
                $insert_student_grades_term3_phase2_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$math','$term3_phase2_mathematics', '$term3_phase2', '$term3_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase2_mathematics = mysqli_query($conn,$insert_student_grades_term3_phase2_mathematics);
                if($run_student_grades_term3_phase2_mathematics){
                echo "added insert_student_grades_term3_phase2_mathematics ";
                }else{
                echo "error insert_student_grades_term3_phase2_mathematics". $conn->error;
                }
                ...
                VALUES ('$lrn', '$science','$term3_phase2_science', '$term3_phase2', '$term3_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase2_science = mysqli_query($conn,$insert_student_grades_term3_phase2_science);
                if($run_student_grades_term3_phase2_science){
                echo "added insert_student_grades_term3_phase2_science ";
                }else{
                echo "error insert_student_grades_term3_phase2_science". $conn->error;
                }
                ...
                VALUES ('$lrn', '$AP','$term3_phase2_araling_panlipunan', '$term3_phase2', '$term3_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase2_AP = mysqli_query($conn,$insert_student_grades_term3_phase2_AP);
                if($run_student_grades_term3_phase2_AP){
                echo "added insert_student_grades_term3_phase2_AP ";
                }else{
                echo "error insert_student_grades_term3_phase2_AP". $conn->error;
                }
                ...
                VALUES ('$lrn', '$epp_tle','$term3_phase2_epp_tle', '$term3_phase2', '$term3_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase2_epp_tle = mysqli_query($conn,$insert_student_grades_term3_phase2_epp_tle);
                if($run_student_grades_term3_phase2_epp_tle){
                echo "added insert_student_grades_term3_phase2_epp_tle ";
                }else{
                echo "error insert_student_grades_term3_phase2_epp_tle". $conn->error;
                }
                
                //insert term3 phase 1 mapeh
                $insert_term3_phase2_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$mapeh','$term3_phase2_average_of_mapeh', '$term3_phase2', '$term3_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase2_mapeh = mysqli_query($conn,$run_student_grades_term3_phase2_mapeh);
                if($run_student_grades_term3_phase2_epp_tle){
                echo "added insert_term3_phase2_average_of_mapeh ";
                }else{
                echo "error insert_term3_phase2_average_of_mapeh". $conn->error;
                }
                
                
                //insert term3 phase 1 mapeh
                $insert_term3_phase2_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$music','$term3_phase2_music', '$term3_phase2', '$term3_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase2_music = mysqli_query($conn,$insert_term3_phase2_music);
                if($run_student_grades_term3_phase2_music){
                echo "added insert_term3_phase2_music ";
                }else{
                echo "error insert_term3_phase2_music". $conn->error;
                }
                
                //insert term3 phase 1 arts
                $insert_term3_phase2_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$arts','$term3_phase2_arts', '$term3_phase2', '$term3_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase2_arts = mysqli_query($conn,$insert_term3_phase2_arts);
                if($run_student_grades_term3_phase2_arts){
                echo "added insert_term3_phase2_arts ";
                }else{
                echo "error insert_term3_phase2_arts". $conn->error;
                }
                
                //insert term3 phase 1 PE
                $insert_term3_phase2_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$PE','$term3_phase2_pe', '$term3_phase2', '$term3_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase2_pe = mysqli_query($conn,$insert_term3_phase2_PE);
                if($run_student_grades_term3_phase2_pe){
                echo "added insert_term3_phase2_PE ";
                }else{
                echo "error insert_term3_phase2_PE". 
                $conn->error;
                }
                
                $insert_term3_phase2_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$health','$term3_phase2_health', '$term3_phase2', '$term3_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase2_health = mysqli_query($conn,$insert_term3_phase2_health);
                if($run_student_grades_term3_phase2_health){
                echo"added insert_term3_phase2_health";
                }
                else{
                echo"error term3 phase 1 health". $conn->error; 
                }
                ...
                $insert_phase2_term3_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase2_term3_general_average', '$term1_phase2','$term1_phase2_remarks', '$dateCreated','$dateUpdated')";
                $run_phase2_term3_general_average = mysqli_query($conn,$insert_phase2_term3_general_average);
                
                if($run_phase2_term3_general_average){
                echo "added student averages term3";
                }else{
                echo "added student averages term3";
                }
                ...
                VALUES ('$lrn', '$mother_tongue','$term1_phase2_mother_tongue', '$term4_phase2', '$term4_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase2_mother_tongue = mysqli_query($conn,$insert_student_grades_term4_phase2_mother_tongue);
                if($run_student_grades_4_phase2_mother_tongue){
                        echo "added insert_student_grades_term4_phase2_mother_tongue ";
                    }else{
                        echo "error insert_student_grades_term4_phase2_mother_tongue". $conn->error;
                    }
                
                    //insert term4 phase 2 Filipino
                ...
                VALUES ('$lrn', '$filipino','$term4_phase2_filipino', '$term4_phase2', '$term4_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase2_filipino = mysqli_query($conn,$insert_student_grades_term4_phase2_filipino);
                if($run_student_grades_term4_phase2_filipino){
                     echo "added insert_student_grades_term4_phase2_filipino ";
                    }
                    else{
                     echo "error insert_student_grades_term4_phase2_filipino". $conn->error;
                    }
                
                //insert term4 phase 2 English
                ...
                VALUES ('$lrn', '$english','$term4_phase2_english', '$term4_phase2', '$term4_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase2_english = mysqli_query($conn,$insert_student_grades_term4_phase2_english);
                if($run_student_grades_term4_phase2_english){
                echo "added insert_student_grades_term4_phase2_english ";
                    }
                else{
                    echo "error insert_student_grades_term4_phase2_english". $conn->error;
                    }
                
                //insert term4 phase 1 math
                $insert_student_grades_term4_phase2_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$math','$term4_phase2_mathematics', '$term4_phase2', '$term4_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase2_mathematics = mysqli_query($conn,$insert_student_grades_term4_phase2_mathematics);
                if($run_student_grades_term4_phase2_mathematics){
                echo "added insert_student_grades_term4_phase2_mathematics ";
                    }
                else{
                     echo "error insert_student_grades_term4_phase2_mathematics". $conn->error;
                    }
                ...
                VALUES ('$lrn', '$science','$term4_phase2_science', '$term4_phase2', '$term4_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase2_science = mysqli_query($conn,$insert_student_grades_term4_phase2_science);
                if($run_student_grades_term4_phase2_science){
                     echo "added insert_student_grades_term4_phase2_science ";
                    }
                    else{
                    echo "error insert_student_grades_term4_phase2_science". $conn->error;
                    }
                ...
                VALUES ('$lrn', '$AP','$term4_phase2_araling_panlipunan', '$term4_phase2', '$term4_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase2_AP = mysqli_query($conn,$insert_student_grades_term4_phase2_AP);
                if($run_student_grades_term4_phase2_AP){
                     echo "added insert_student_grades_term4_phase2_AP ";
                    }
                else{
                      echo "error insert_student_grades_term4_phase2_AP". $conn->error;
                 }
                ...
                VALUES ('$lrn', '$epp_tle','$term4_phase2_epp_tle', '$term4_phase2', '$term4_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase2_epp_tle = mysqli_query($conn,$insert_student_grades_term4_phase2_epp_tle);
                if($run_student_grades_term4_phase2_epp_tle){
                    echo "added insert_student_grades_term4_phase2_epp_tle ";
                    }
                else{
                  echo "error insert_student_grades_term4_phase2_epp_tle". $conn->error;
                    }
                
                //insert term4 phase 1 mapeh
                $insert_term4_phase2_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$mapeh','$term4_phase2_average_of_mapeh', '$term4_phase2', '$term4_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase2_mapeh = mysqli_query($conn,$run_student_grades_term4_phase2_mapeh);
                if($run_student_grades_term4_phase2_epp_tle){
                echo "added insert_term4_phase2_average_of_mapeh ";
                }
                else{
                 echo "error insert_term4_phase2_average_of_mapeh". $conn->error;
                    }
                
                    
                //insert term4 phase 1 mapeh
                $insert_term4_phase2_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$music','$term4_phase2_music', '$term4_phase2', '$term4_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase2_music = mysqli_query($conn,$insert_term4_phase2_music);
                if($run_student_grades_term4_phase2_music){
                     echo "added insert_term4_phase2_music ";
                  }
                  else{
                     echo "error insert_term4_phase2_music". $conn->error;
                    }
                
                //insert term4 phase 1 arts
                $insert_term4_phase2_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$arts','$term4_phase2_arts', '$term4_phase2', '$term4_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase2_arts = mysqli_query($conn,$insert_term4_phase2_arts);
                if($run_student_grades_term4_phase2_arts){
                echo "added insert_term4_phase2_arts ";
                }else{
                echo "error insert_term4_phase2_arts". $conn->error;
                }
                
                //insert term4 phase 1 PE
                $insert_term4_phase2_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$PE','$term4_phase2_pe', '$term4_phase2', '$term4_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase2_pe = mysqli_query($conn,$insert_term4_phase2_PE);
                if($run_student_grades_term4_phase2_pe){
                echo "added insert_term4_phase2_PE ";
                }else{
                echo "error insert_term4_phase2_PE". 
                $conn->error;
                }
                
                $insert_term4_phase2_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$health','$term4_phase2_health', '$term4_phase2', '$term4_phase2_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase2_health = mysqli_query($conn,$insert_term4_phase2_health);
                if($run_student_grades_term4_phase2_health){
                echo"added insert_term4_phase2_health";
                }
                else{
                echo"error term4 phase 1 health". $conn->error; 
                }
                ...
                if($run_student_grades_term4_phase2_islamic){
                     echo  "added term islamic" . '<br>';
                      ...
                      echo "error term4_phase2 islamic" . '<br>';
                        ...
                        // general average of phase 1 term 4 
                    $insert_phase2_term4_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase2_term4_general_average', '$term1_phase2','$term1_phase2_remarks', '$dateCreated','$dateUpdated')";
                $run_phase2_term4_general_average = mysqli_query($conn,$insert_phase2_term4_general_average);
                
                if($run_phase2_term4_general_average){
                    echo "added student averages term4";
                }else{
                    echo "added student averages term4";
                }
                ...
                $insert_student_final_ratings_english = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$english','$phase2_final_rating_english', '$phase2_term5', '$phase2', '$phase2_final_rating_english', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_english = mysqli_query($conn,$insert_student_final_ratings_english);
                ...
                $insert_student_final_ratings_math = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$math','$phase2_final_rating_math', '$phase2_term5', '$phase2', '$phase2_final_rating_math', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_math = mysqli_query($conn,$insert_student_final_ratings_math);
                ...
                $insert_student_final_ratings_science = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$science','$phase2_final_rating_science', '$phase2_term5', '$phase2', '$phase2_final_rating_science', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_science = mysqli_query($conn,$insert_student_final_ratings_science);
                ...
                $insert_student_final_ratings_AP = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$AP','$phase2_final_rating_AP', '$phase2_term5', '$phase2', '$phase2_final_rating_AP', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_AP = mysqli_query($conn,$insert_student_final_ratings_AP);
                ...
                $insert_student_final_ratings_epp_tle = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$epp_tle','$phase2_final_rating_epp_tle', '$phase2_term5', '$phase2', '$phase2_final_rating_epp_tle', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_epp_tle = mysqli_query($conn,$insert_student_final_ratings_epp_tle);
                ...
                $insert_student_final_ratings_mapeh = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$mapeh','$phase2_final_rating_mapeh', '$phase2_term5', '$phase2', '$phase2_final_rating_mapeh', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_mapeh = mysqli_query($conn,$insert_student_final_ratings_mapeh);
                ...
                $insert_student_final_ratings_music = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$music','$phase2_final_rating_music', '$phase2_term5', '$phase2', '$phase2_final_rating_music', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_music = mysqli_query($conn,$insert_student_final_ratings_music);
                ...
                $insert_student_final_ratings_arts = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$arts','$phase2_final_rating_arts', '$phase2_term5', '$phase2', '$phase2_final_rating_arts', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_arts = mysqli_query($conn,$insert_student_final_ratings_arts);
                ...
                $insert_student_final_ratings_pe = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$PE','$phase2_final_rating_PE', '$phase2_term5', '$phase2', '$phase2_final_rating_PE', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_pe = mysqli_query($conn,$insert_student_final_ratings_pe);
                ...
                $insert_student_final_ratings_health = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$health','$phase2_final_rating_health', '$phase2_term5', '$phase2', '$phase2_final_rating_health', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_health = mysqli_query($conn,$insert_student_final_ratings_health);
                ...
                $insert_student_final_ratings_esp = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$esp', '$phase2_final_rating_esp','$phase2_term5', '$phase2', '$phase2_final_rating_esp', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_esp = mysqli_query($conn,$insert_student_final_ratings_esp);
                ...
                $insert_student_final_ratings_arabic = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$arabic_language','$phase2_final_rating_arabic_language', '$phase2_term5', '$phase2', '$phase2_final_rating_arabic_language', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_arabic = mysqli_query($conn,$insert_student_final_ratings_arabic);
                ...
                $insert_student_final_ratings_arabic = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$islamic_values','$phase2_final_rating_islamic_values', '$phase2_term5', '$phase2', '$phase2_final_rating_islamic_values_outpu', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_arabic = mysqli_query($conn,$insert_student_final_ratings_arabic);
                ...
                if($run_student_final_ratings_arabic){
                    ...
                    //general averag of phase 1 term 5 
                $insert_phase2_term5_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase2_term5_general_average', '$term1_phase2','$term1_phase2_remarks', '$dateCreated','$dateUpdated')";
            ...
            if($phase3_run_scholastic_records){
                ...
                if($run_student_grades_term1_phase3_islamic){
                     echo  "added term islamic" . '<br>';
                      ...
                      echo "error term1_phase3 islamic" . '<br>';
                        ...
                        //general average
                    $insert_phase3_term1_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn', '$phase3_term1_general_average', '$term1_phase3','$phase3_remarks','$dateCreated', '$dateUpdated')";
                ...
                VALUES ('$lrn', '$mother_tongue','$term1_phase3_mother_tongue', '$term2_phase3', '$term2_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase3_mother_tongue = mysqli_query($conn,$insert_student_grades_term2_phase3_mother_tongue);
                if($run_student_grades_term2_phase3_mother_tongue){
                echo "added insert_student_grades_term2_phase3_mother_tongue ";
                }else{
                echo "error insert_student_grades_term2_phase3_mother_tongue". $conn->error;
                }
                ...
                VALUES ('$lrn', '$filipino','$term2_phase3_filipino', '$term2_phase3', '$term2_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase3_filipino = mysqli_query($conn,$insert_student_grades_term2_phase3_filipino);
                if($run_student_grades_term2_phase3_filipino){
                echo "added insert_student_grades_term2_phase3_filipino ";
                }else{
                echo "error insert_student_grades_term2_phase3_filipino". $conn->error;
                }
                ...
                VALUES ('$lrn', '$english','$term2_phase3_english', '$term2_phase3', '$term2_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase3_english = mysqli_query($conn,$insert_student_grades_term2_phase3_english);
                if($run_student_grades_term2_phase3_english){
                echo "added insert_student_grades_term2_phase3_english ";
                }else{
                echo "error insert_student_grades_term2_phase3_english". $conn->error;
                }
                
                //insert term2 phase 1 math
                $insert_student_grades_term2_phase3_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$math','$term2_phase3_mathematics', '$term2_phase3', '$term2_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase3_mathematics = mysqli_query($conn,$insert_student_grades_term2_phase3_mathematics);
                if($run_student_grades_term2_phase3_mathematics){
                echo "added insert_student_grades_term1_phase3_mathematics ";
                }else{
                echo "error insert_student_grades_term1_phase3_mathematics". $conn->error;
                }
                ...
                VALUES ('$lrn', '$science','$term2_phase3_science', '$term2_phase3', '$term2_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase3_science = mysqli_query($conn,$insert_student_grades_term2_phase3_science);
                if($run_student_grades_term2_phase3_science){
                echo "added insert_student_grades_term2_phase3_science ";
                }else{
                echo "error insert_student_grades_term2_phase3_science". $conn->error;
                }
                ...
                VALUES ('$lrn', '$AP','$term2_phase3_araling_panlipunan', '$term2_phase3', '$term2_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase3_AP = mysqli_query($conn,$insert_student_grades_term2_phase3_AP);
                if($run_student_grades_term2_phase3_AP){
                echo "added insert_student_grades_term2_phase3_AP ";
                }else{
                echo "error insert_student_grades_term2_phase3_AP". $conn->error;
                }
                ...
                VALUES ('$lrn', '$epp_tle','$term2_phase3_epp_tle', '$term2_phase3', '$term2_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase3_epp_tle = mysqli_query($conn,$insert_student_grades_term2_phase3_epp_tle);
                if($run_student_grades_term2_phase3_epp_tle){
                echo "added insert_student_grades_term2_phase3_epp_tle ";
                }else{
                echo "error insert_student_grades_term2_phase3_epp_tle". $conn->error;
                }
                
                //insert term2 phase 1 mapeh
                $insert_term2_phase3_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$mapeh','$term2_phase3_average_of_mapeh', '$term2_phase3', '$term2_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase3_mapeh = mysqli_query($conn,$run_student_grades_term2_phase3_mapeh);
                if($run_student_grades_term2_phase3_epp_tle){
                echo "added insert_term2_phase3_average_of_mapeh ";
                }else{
                echo "error insert_term2_phase3_average_of_mapeh". $conn->error;
                }
                
                
                //insert term2 phase 1 mapeh
                $insert_term2_phase3_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$music','$term2_phase3_music', '$term2_phase3', '$term2_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase3_music = mysqli_query($conn,$insert_term2_phase3_music);
                if($run_student_grades_term2_phase3_music){
                echo "added insert_term2_phase3_music ";
                }else{
                echo "error insert_term2_phase3_music". $conn->error;
                }
                
                //insert term2 phase 1 arts
                $insert_term2_phase3_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$arts','$term2_phase3_arts', '$term2_phase3', '$term2_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase3_arts = mysqli_query($conn,$insert_term2_phase3_arts);
                if($run_student_grades_term2_phase3_arts){
                echo "added insert_term2_phase3_arts ";
                }else{
                echo "error insert_term2_phase3_arts". $conn->error;
                }
                
                //insert term2 phase 1 PE
                $insert_term2_phase3_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$PE','$term2_phase3_pe', '$term2_phase3', '$term2_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase3_pe = mysqli_query($conn,$insert_term2_phase3_PE);
                if($run_student_grades_term2_phase3_pe){
                echo "added insert_term2_phase3_PE ";
                }else{
                echo "error insert_term2_phase3_PE". 
                $conn->error;
                }
                
                $insert_term2_phase3_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$health','$term2_phase3_health', '$term2_phase3', '$term2_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase3_health = mysqli_query($conn,$insert_term2_phase3_health);
                if($run_student_grades_term2_phase3_health){
                echo"added insert_term2_phase3_health";
                }
                else{
                echo"error term2 phase 1 health". $conn->error; 
                }
                ...
                if($run_student_grades_term2_phase3_islamic){
                     echo  "added term islamic" . '<br>';
                      ...
                      echo "error term2_phase3 islamic" . '<br>';
                        ...
                        // general average of term 2
                $insert_phase3_term2_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase3_term2_general_average', '$term1_phase3','$term1_phase3_remarks', '$dateCreated','$dateUpdated')";
                $run_phase3_term2_general_average = mysqli_query($conn,$insert_phase3_term2_general_average);
                
                 if($run_phase3_term2_general_average){
                            echo "added student averages term2";
                 }else{
                      echo "error student averages term2";
                     }
                ...
                VALUES ('$lrn', '$mother_tongue','$term1_phase3_mother_tongue', '$term3_phase3', '$term3_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase3_mother_tongue = mysqli_query($conn,$insert_student_grades_term3_phase3_mother_tongue);
                if($run_student_grades_3_phase3_mother_tongue){
                echo "added insert_student_grades_term3_phase3_mother_tongue ";
                }else{
                echo "error insert_student_grades_term3_phase3_mother_tongue". $conn->error;
                }
                ...
                VALUES ('$lrn', '$filipino','$term3_phase3_filipino', '$term3_phase3', '$term3_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase3_filipino = mysqli_query($conn,$insert_student_grades_term3_phase3_filipino);
                if($run_student_grades_term3_phase3_filipino){
                echo "added insert_student_grades_term3_phase3_filipino ";
                }else{
                echo "error insert_student_grades_term3_phase3_filipino". $conn->error;
                }
                ...
                VALUES ('$lrn', '$english','$term3_phase3_english', '$term3_phase3', '$term3_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase3_english = mysqli_query($conn,$insert_student_grades_term3_phase3_english);
                if($run_student_grades_term3_phase3_english){
                echo "added insert_student_grades_term3_phase3_english ";
                }else{
                echo "error insert_student_grades_term3_phase3_english". $conn->error;
                }
                
                //insert term3 phase 1 math
                $insert_student_grades_term3_phase3_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$math','$term3_phase3_mathematics', '$term3_phase3', '$term3_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase3_mathematics = mysqli_query($conn,$insert_student_grades_term3_phase3_mathematics);
                if($run_student_grades_term3_phase3_mathematics){
                echo "added insert_student_grades_term3_phase3_mathematics ";
                }else{
                echo "error insert_student_grades_term3_phase3_mathematics". $conn->error;
                }
                ...
                VALUES ('$lrn', '$science','$term3_phase3_science', '$term3_phase3', '$term3_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase3_science = mysqli_query($conn,$insert_student_grades_term3_phase3_science);
                if($run_student_grades_term3_phase3_science){
                echo "added insert_student_grades_term3_phase3_science ";
                }else{
                echo "error insert_student_grades_term3_phase3_science". $conn->error;
                }
                ...
                VALUES ('$lrn', '$AP','$term3_phase3_araling_panlipunan', '$term3_phase3', '$term3_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase3_AP = mysqli_query($conn,$insert_student_grades_term3_phase3_AP);
                if($run_student_grades_term3_phase3_AP){
                echo "added insert_student_grades_term3_phase3_AP ";
                }else{
                echo "error insert_student_grades_term3_phase3_AP". $conn->error;
                }
                ...
                VALUES ('$lrn', '$epp_tle','$term3_phase3_epp_tle', '$term3_phase3', '$term3_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase3_epp_tle = mysqli_query($conn,$insert_student_grades_term3_phase3_epp_tle);
                if($run_student_grades_term3_phase3_epp_tle){
                echo "added insert_student_grades_term3_phase3_epp_tle ";
                }else{
                echo "error insert_student_grades_term3_phase3_epp_tle". $conn->error;
                }
                
                //insert term3 phase 1 mapeh
                $insert_term3_phase3_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$mapeh','$term3_phase3_average_of_mapeh', '$term3_phase3', '$term3_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase3_mapeh = mysqli_query($conn,$run_student_grades_term3_phase3_mapeh);
                if($run_student_grades_term3_phase3_epp_tle){
                echo "added insert_term3_phase3_average_of_mapeh ";
                }else{
                echo "error insert_term3_phase3_average_of_mapeh". $conn->error;
                }
                
                
                //insert term3 phase 1 mapeh
                $insert_term3_phase3_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$music','$term3_phase3_music', '$term3_phase3', '$term3_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase3_music = mysqli_query($conn,$insert_term3_phase3_music);
                if($run_student_grades_term3_phase3_music){
                echo "added insert_term3_phase3_music ";
                }else{
                echo "error insert_term3_phase3_music". $conn->error;
                }
                
                //insert term3 phase 1 arts
                $insert_term3_phase3_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$arts','$term3_phase3_arts', '$term3_phase3', '$term3_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase3_arts = mysqli_query($conn,$insert_term3_phase3_arts);
                if($run_student_grades_term3_phase3_arts){
                echo "added insert_term3_phase3_arts ";
                }else{
                echo "error insert_term3_phase3_arts". $conn->error;
                }
                
                //insert term3 phase 1 PE
                $insert_term3_phase3_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$PE','$term3_phase3_pe', '$term3_phase3', '$term3_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase3_pe = mysqli_query($conn,$insert_term3_phase3_PE);
                if($run_student_grades_term3_phase3_pe){
                echo "added insert_term3_phase3_PE ";
                }else{
                echo "error insert_term3_phase3_PE". 
                $conn->error;
                }
                
                $insert_term3_phase3_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$health','$term3_phase3_health', '$term3_phase3', '$term3_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase3_health = mysqli_query($conn,$insert_term3_phase3_health);
                if($run_student_grades_term3_phase3_health){
                echo"added insert_term3_phase3_health";
                }
                else{
                echo"error term3 phase 1 health". $conn->error; 
                }
                ...
                $insert_phase3_term3_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase3_term3_general_average', '$term1_phase3','$term1_phase3_remarks', '$dateCreated','$dateUpdated')";
                $run_phase3_term3_general_average = mysqli_query($conn,$insert_phase3_term3_general_average);
                
                if($run_phase3_term3_general_average){
                echo "added student averages term3";
                }else{
                echo "added student averages term3";
                }
                ...
                VALUES ('$lrn', '$mother_tongue','$term1_phase3_mother_tongue', '$term4_phase3', '$term4_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase3_mother_tongue = mysqli_query($conn,$insert_student_grades_term4_phase3_mother_tongue);
                if($run_student_grades_4_phase3_mother_tongue){
                        echo "added insert_student_grades_term4_phase3_mother_tongue ";
                    }else{
                        echo "error insert_student_grades_term4_phase3_mother_tongue". $conn->error;
                    }
                ...
                VALUES ('$lrn', '$filipino','$term4_phase3_filipino', '$term4_phase3', '$term4_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase3_filipino = mysqli_query($conn,$insert_student_grades_term4_phase3_filipino);
                if($run_student_grades_term4_phase3_filipino){
                     echo "added insert_student_grades_term4_phase3_filipino ";
                    }
                    else{
                     echo "error insert_student_grades_term4_phase3_filipino". $conn->error;
                    }
                ...
                VALUES ('$lrn', '$english','$term4_phase3_english', '$term4_phase3', '$term4_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase3_english = mysqli_query($conn,$insert_student_grades_term4_phase3_english);
                if($run_student_grades_term4_phase3_english){
                echo "added insert_student_grades_term4_phase3_english ";
                    }
                else{
                    echo "error insert_student_grades_term4_phase3_english". $conn->error;
                    }
                
                //insert term4 phase 1 math
                $insert_student_grades_term4_phase3_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$math','$term4_phase3_mathematics', '$term4_phase3', '$term4_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase3_mathematics = mysqli_query($conn,$insert_student_grades_term4_phase3_mathematics);
                if($run_student_grades_term4_phase3_mathematics){
                echo "added insert_student_grades_term4_phase3_mathematics ";
                    }
                else{
                     echo "error insert_student_grades_term4_phase3_mathematics". $conn->error;
                    }
                ...
                VALUES ('$lrn', '$science','$term4_phase3_science', '$term4_phase3', '$term4_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase3_science = mysqli_query($conn,$insert_student_grades_term4_phase3_science);
                if($run_student_grades_term4_phase3_science){
                     echo "added insert_student_grades_term4_phase3_science ";
                    }
                    else{
                    echo "error insert_student_grades_term4_phase3_science". $conn->error;
                    }
                ...
                VALUES ('$lrn', '$AP','$term4_phase3_araling_panlipunan', '$term4_phase3', '$term4_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase3_AP = mysqli_query($conn,$insert_student_grades_term4_phase3_AP);
                if($run_student_grades_term4_phase3_AP){
                     echo "added insert_student_grades_term4_phase3_AP ";
                    }
                else{
                      echo "error insert_student_grades_term4_phase3_AP". $conn->error;
                 }
                ...
                VALUES ('$lrn', '$epp_tle','$term4_phase3_epp_tle', '$term4_phase3', '$term4_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase3_epp_tle = mysqli_query($conn,$insert_student_grades_term4_phase3_epp_tle);
                if($run_student_grades_term4_phase3_epp_tle){
                    echo "added insert_student_grades_term4_phase3_epp_tle ";
                    }
                else{
                  echo "error insert_student_grades_term4_phase3_epp_tle". $conn->error;
                    }
                
                //insert term4 phase 1 mapeh
                $insert_term4_phase3_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$mapeh','$term4_phase3_average_of_mapeh', '$term4_phase3', '$term4_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase3_mapeh = mysqli_query($conn,$run_student_grades_term4_phase3_mapeh);
                if($run_student_grades_term4_phase3_epp_tle){
                echo "added insert_term4_phase3_average_of_mapeh ";
                }
                else{
                 echo "error insert_term4_phase3_average_of_mapeh". $conn->error;
                    }
                
                    
                //insert term4 phase 1 mapeh
                $insert_term4_phase3_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$music','$term4_phase3_music', '$term4_phase3', '$term4_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase3_music = mysqli_query($conn,$insert_term4_phase3_music);
                if($run_student_grades_term4_phase3_music){
                     echo "added insert_term4_phase3_music ";
                  }
                  else{
                     echo "error insert_term4_phase3_music". $conn->error;
                    }
                
                //insert term4 phase 1 arts
                $insert_term4_phase3_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$arts','$term4_phase3_arts', '$term4_phase3', '$term4_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase3_arts = mysqli_query($conn,$insert_term4_phase3_arts);
                if($run_student_grades_term4_phase3_arts){
                echo "added insert_term4_phase3_arts ";
                }else{
                echo "error insert_term4_phase3_arts". $conn->error;
                }
                
                //insert term4 phase 1 PE
                $insert_term4_phase3_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$PE','$term4_phase3_pe', '$term4_phase3', '$term4_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase3_pe = mysqli_query($conn,$insert_term4_phase3_PE);
                if($run_student_grades_term4_phase3_pe){
                echo "added insert_term4_phase3_PE ";
                }else{
                echo "error insert_term4_phase3_PE". 
                $conn->error;
                }
                
                $insert_term4_phase3_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$health','$term4_phase3_health', '$term4_phase3', '$term4_phase3_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase3_health = mysqli_query($conn,$insert_term4_phase3_health);
                if($run_student_grades_term4_phase3_health){
                echo"added insert_term4_phase3_health";
                }
                else{
                echo"error term4 phase 1 health". $conn->error; 
                }
                ...
                if($run_student_grades_term4_phase3_islamic){
                     echo  "added term islamic" . '<br>';
                      ...
                      echo "error term4_phase3 islamic" . '<br>';
                        ...
                        // general average of phase 1 term 4 
                    $insert_phase3_term4_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase3_term4_general_average', '$term1_phase3','$term1_phase3_remarks', '$dateCreated','$dateUpdated')";
                $run_phase3_term4_general_average = mysqli_query($conn,$insert_phase3_term4_general_average);
                
                if($run_phase3_term4_general_average){
                    echo "added student averages term4";
                }else{
                    echo "added student averages term4";
                }
                ...
                $insert_student_final_ratings_english = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$english','$phase3_final_rating_english', '$phase3_term5', '$phase3', '$phase3_final_rating_english', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_english = mysqli_query($conn,$insert_student_final_ratings_english);
                ...
                $insert_student_final_ratings_math = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$math','$phase3_final_rating_math', '$phase3_term5', '$phase3', '$phase3_final_rating_math', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_math = mysqli_query($conn,$insert_student_final_ratings_math);
                ...
                $insert_student_final_ratings_science = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$science','$phase3_final_rating_science', '$phase3_term5', '$phase3', '$phase3_final_rating_science', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_science = mysqli_query($conn,$insert_student_final_ratings_science);
                ...
                $insert_student_final_ratings_AP = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$AP','$phase3_final_rating_AP', '$phase3_term5', '$phase3', '$phase3_final_rating_AP', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_AP = mysqli_query($conn,$insert_student_final_ratings_AP);
                ...
                $insert_student_final_ratings_epp_tle = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$epp_tle','$phase3_final_rating_epp_tle', '$phase3_term5', '$phase3', '$phase3_final_rating_epp_tle', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_epp_tle = mysqli_query($conn,$insert_student_final_ratings_epp_tle);
                ...
                $insert_student_final_ratings_mapeh = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$mapeh','$phase3_final_rating_mapeh', '$phase3_term5', '$phase3', '$phase3_final_rating_mapeh', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_mapeh = mysqli_query($conn,$insert_student_final_ratings_mapeh);
                ...
                $insert_student_final_ratings_music = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$music','$phase3_final_rating_music', '$phase3_term5', '$phase3', '$phase3_final_rating_music', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_music = mysqli_query($conn,$insert_student_final_ratings_music);
                ...
                $insert_student_final_ratings_arts = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$arts','$phase3_final_rating_arts', '$phase3_term5', '$phase3', '$phase3_final_rating_arts', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_arts = mysqli_query($conn,$insert_student_final_ratings_arts);
                ...
                $insert_student_final_ratings_pe = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$PE','$phase3_final_rating_PE', '$phase3_term5', '$phase3', '$phase3_final_rating_PE', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_pe = mysqli_query($conn,$insert_student_final_ratings_pe);
                ...
                $insert_student_final_ratings_health = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$health','$phase3_final_rating_health', '$phase3_term5', '$phase3', '$phase3_final_rating_health', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_health = mysqli_query($conn,$insert_student_final_ratings_health);
                ...
                $insert_student_final_ratings_esp = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$esp', '$phase3_final_rating_esp','$phase3_term5', '$phase3', '$phase3_final_rating_esp', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_esp = mysqli_query($conn,$insert_student_final_ratings_esp);
                ...
                $insert_student_final_ratings_arabic = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$arabic_language','$phase3_final_rating_arabic_language', '$phase3_term5', '$phase3', '$phase3_final_rating_arabic_language', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_arabic = mysqli_query($conn,$insert_student_final_ratings_arabic);
                ...
                $insert_student_final_ratings_arabic = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$islamic_values','$phase3_final_rating_islamic_values', '$phase3_term5', '$phase3', '$phase3_final_rating_islamic_values_outpu', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_arabic = mysqli_query($conn,$insert_student_final_ratings_arabic);
                ...
                if($run_student_final_ratings_arabic){
                    ...
                    //general averag of phase 1 term 5 
                $insert_phase3_term5_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase3_term5_general_average', '$term1_phase3','$term1_phase3_remarks', '$dateCreated','$dateUpdated')";
                ...
                if($phase4_run_scholastic_records){
                    ...
                    if($run_student_grades_term1_phase4_islamic){
                         echo  "added term islamic" . '<br>';
                          ...
                          echo "error term1_phase4 islamic" . '<br>';
                            ...
                            //general average
                        $insert_phase4_term1_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn', '$phase4_term1_general_average', '$term1_phase4','$phase4_remarks','$dateCreated', '$dateUpdated')";
                    ...
                    VALUES ('$lrn', '$mother_tongue','$term1_phase4_mother_tongue', '$term2_phase4', '$term2_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term2_phase4_mother_tongue = mysqli_query($conn,$insert_student_grades_term2_phase4_mother_tongue);
                    if($run_student_grades_term2_phase4_mother_tongue){
                    echo "added insert_student_grades_term2_phase4_mother_tongue ";
                    }else{
                    echo "error insert_student_grades_term2_phase4_mother_tongue". $conn->error;
                    }
                    ...
                    VALUES ('$lrn', '$filipino','$term2_phase4_filipino', '$term2_phase4', '$term2_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term2_phase4_filipino = mysqli_query($conn,$insert_student_grades_term2_phase4_filipino);
                    if($run_student_grades_term2_phase4_filipino){
                    echo "added insert_student_grades_term2_phase4_filipino ";
                    }else{
                    echo "error insert_student_grades_term2_phase4_filipino". $conn->error;
                    }
                    ...
                    VALUES ('$lrn', '$english','$term2_phase4_english', '$term2_phase4', '$term2_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term2_phase4_english = mysqli_query($conn,$insert_student_grades_term2_phase4_english);
                    if($run_student_grades_term2_phase4_english){
                    echo "added insert_student_grades_term2_phase4_english ";
                    }else{
                    echo "error insert_student_grades_term2_phase4_english". $conn->error;
                    }
                    
                    //insert term2 phase 1 math
                    $insert_student_grades_term2_phase4_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$math','$term2_phase4_mathematics', '$term2_phase4', '$term2_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term2_phase4_mathematics = mysqli_query($conn,$insert_student_grades_term2_phase4_mathematics);
                    if($run_student_grades_term2_phase4_mathematics){
                    echo "added insert_student_grades_term1_phase4_mathematics ";
                    }else{
                    echo "error insert_student_grades_term1_phase4_mathematics". $conn->error;
                    }
                    ...
                    VALUES ('$lrn', '$science','$term2_phase4_science', '$term2_phase4', '$term2_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term2_phase4_science = mysqli_query($conn,$insert_student_grades_term2_phase4_science);
                    if($run_student_grades_term2_phase4_science){
                    echo "added insert_student_grades_term2_phase4_science ";
                    }else{
                    echo "error insert_student_grades_term2_phase4_science". $conn->error;
                    }
                    ...
                    VALUES ('$lrn', '$AP','$term2_phase4_araling_panlipunan', '$term2_phase4', '$term2_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term2_phase4_AP = mysqli_query($conn,$insert_student_grades_term2_phase4_AP);
                    if($run_student_grades_term2_phase4_AP){
                    echo "added insert_student_grades_term2_phase4_AP ";
                    }else{
                    echo "error insert_student_grades_term2_phase4_AP". $conn->error;
                    }
                    ...
                    VALUES ('$lrn', '$epp_tle','$term2_phase4_epp_tle', '$term2_phase4', '$term2_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term2_phase4_epp_tle = mysqli_query($conn,$insert_student_grades_term2_phase4_epp_tle);
                    if($run_student_grades_term2_phase4_epp_tle){
                    echo "added insert_student_grades_term2_phase4_epp_tle ";
                    }else{
                    echo "error insert_student_grades_term2_phase4_epp_tle". $conn->error;
                    }
                    
                    //insert term2 phase 1 mapeh
                    $insert_term2_phase4_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$mapeh','$term2_phase4_average_of_mapeh', '$term2_phase4', '$term2_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term2_phase4_mapeh = mysqli_query($conn,$run_student_grades_term2_phase4_mapeh);
                    if($run_student_grades_term2_phase4_epp_tle){
                    echo "added insert_term2_phase4_average_of_mapeh ";
                    }else{
                    echo "error insert_term2_phase4_average_of_mapeh". $conn->error;
                    }
                    
                    
                    //insert term2 phase 1 mapeh
                    $insert_term2_phase4_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$music','$term2_phase4_music', '$term2_phase4', '$term2_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term2_phase4_music = mysqli_query($conn,$insert_term2_phase4_music);
                    if($run_student_grades_term2_phase4_music){
                    echo "added insert_term2_phase4_music ";
                    }else{
                    echo "error insert_term2_phase4_music". $conn->error;
                    }
                    
                    //insert term2 phase 1 arts
                    $insert_term2_phase4_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$arts','$term2_phase4_arts', '$term2_phase4', '$term2_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term2_phase4_arts = mysqli_query($conn,$insert_term2_phase4_arts);
                    if($run_student_grades_term2_phase4_arts){
                    echo "added insert_term2_phase4_arts ";
                    }else{
                    echo "error insert_term2_phase4_arts". $conn->error;
                    }
                    
                    //insert term2 phase 1 PE
                    $insert_term2_phase4_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$PE','$term2_phase4_pe', '$term2_phase4', '$term2_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term2_phase4_pe = mysqli_query($conn,$insert_term2_phase4_PE);
                    if($run_student_grades_term2_phase4_pe){
                    echo "added insert_term2_phase4_PE ";
                    }else{
                    echo "error insert_term2_phase4_PE". 
                    $conn->error;
                    }
                    
                    $insert_term2_phase4_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$health','$term2_phase4_health', '$term2_phase4', '$term2_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term2_phase4_health = mysqli_query($conn,$insert_term2_phase4_health);
                    if($run_student_grades_term2_phase4_health){
                    echo"added insert_term2_phase4_health";
                    }
                    else{
                    echo"error term2 phase 1 health". $conn->error; 
                    }
                    ...
                    if($run_student_grades_term2_phase4_islamic){
                         echo  "added term islamic" . '<br>';
                          ...
                          echo "error term2_phase4 islamic" . '<br>';
                            ...
                            // general average of term 2
                    $insert_phase4_term2_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase4_term2_general_average', '$term1_phase4','$term1_phase4_remarks', '$dateCreated','$dateUpdated')";
                    $run_phase4_term2_general_average = mysqli_query($conn,$insert_phase4_term2_general_average);
                    
                     if($run_phase4_term2_general_average){
                                echo "added student averages term2";
                     }else{
                          echo "error student averages term2";
                         }
                    ...
                    VALUES ('$lrn', '$mother_tongue','$term1_phase4_mother_tongue', '$term3_phase4', '$term3_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term3_phase4_mother_tongue = mysqli_query($conn,$insert_student_grades_term3_phase4_mother_tongue);
                    if($run_student_grades_3_phase4_mother_tongue){
                    echo "added insert_student_grades_term3_phase4_mother_tongue ";
                    }else{
                    echo "error insert_student_grades_term3_phase4_mother_tongue". $conn->error;
                    }
                    ...
                    VALUES ('$lrn', '$filipino','$term3_phase4_filipino', '$term3_phase4', '$term3_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term3_phase4_filipino = mysqli_query($conn,$insert_student_grades_term3_phase4_filipino);
                    if($run_student_grades_term3_phase4_filipino){
                    echo "added insert_student_grades_term3_phase4_filipino ";
                    }else{
                    echo "error insert_student_grades_term3_phase4_filipino". $conn->error;
                    }
                    ...
                    VALUES ('$lrn', '$english','$term3_phase4_english', '$term3_phase4', '$term3_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term3_phase4_english = mysqli_query($conn,$insert_student_grades_term3_phase4_english);
                    if($run_student_grades_term3_phase4_english){
                    echo "added insert_student_grades_term3_phase4_english ";
                    }else{
                    echo "error insert_student_grades_term3_phase4_english". $conn->error;
                    }
                    
                    //insert term3 phase 1 math
                    $insert_student_grades_term3_phase4_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$math','$term3_phase4_mathematics', '$term3_phase4', '$term3_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term3_phase4_mathematics = mysqli_query($conn,$insert_student_grades_term3_phase4_mathematics);
                    if($run_student_grades_term3_phase4_mathematics){
                    echo "added insert_student_grades_term3_phase4_mathematics ";
                    }else{
                    echo "error insert_student_grades_term3_phase4_mathematics". $conn->error;
                    }
                    ...
                    VALUES ('$lrn', '$science','$term3_phase4_science', '$term3_phase4', '$term3_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term3_phase4_science = mysqli_query($conn,$insert_student_grades_term3_phase4_science);
                    if($run_student_grades_term3_phase4_science){
                    echo "added insert_student_grades_term3_phase4_science ";
                    }else{
                    echo "error insert_student_grades_term3_phase4_science". $conn->error;
                    }
                    ...
                    VALUES ('$lrn', '$AP','$term3_phase4_araling_panlipunan', '$term3_phase4', '$term3_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term3_phase4_AP = mysqli_query($conn,$insert_student_grades_term3_phase4_AP);
                    if($run_student_grades_term3_phase4_AP){
                    echo "added insert_student_grades_term3_phase4_AP ";
                    }else{
                    echo "error insert_student_grades_term3_phase4_AP". $conn->error;
                    }
                    ...
                    VALUES ('$lrn', '$epp_tle','$term3_phase4_epp_tle', '$term3_phase4', '$term3_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term3_phase4_epp_tle = mysqli_query($conn,$insert_student_grades_term3_phase4_epp_tle);
                    if($run_student_grades_term3_phase4_epp_tle){
                    echo "added insert_student_grades_term3_phase4_epp_tle ";
                    }else{
                    echo "error insert_student_grades_term3_phase4_epp_tle". $conn->error;
                    }
                    
                    //insert term3 phase 1 mapeh
                    $insert_term3_phase4_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$mapeh','$term3_phase4_average_of_mapeh', '$term3_phase4', '$term3_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term3_phase4_mapeh = mysqli_query($conn,$run_student_grades_term3_phase4_mapeh);
                    if($run_student_grades_term3_phase4_epp_tle){
                    echo "added insert_term3_phase4_average_of_mapeh ";
                    }else{
                    echo "error insert_term3_phase4_average_of_mapeh". $conn->error;
                    }
                    
                    
                    //insert term3 phase 1 mapeh
                    $insert_term3_phase4_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$music','$term3_phase4_music', '$term3_phase4', '$term3_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term3_phase4_music = mysqli_query($conn,$insert_term3_phase4_music);
                    if($run_student_grades_term3_phase4_music){
                    echo "added insert_term3_phase4_music ";
                    }else{
                    echo "error insert_term3_phase4_music". $conn->error;
                    }
                    
                    //insert term3 phase 1 arts
                    $insert_term3_phase4_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$arts','$term3_phase4_arts', '$term3_phase4', '$term3_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term3_phase4_arts = mysqli_query($conn,$insert_term3_phase4_arts);
                    if($run_student_grades_term3_phase4_arts){
                    echo "added insert_term3_phase4_arts ";
                    }else{
                    echo "error insert_term3_phase4_arts". $conn->error;
                    }
                    
                    //insert term3 phase 1 PE
                    $insert_term3_phase4_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$PE','$term3_phase4_pe', '$term3_phase4', '$term3_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term3_phase4_pe = mysqli_query($conn,$insert_term3_phase4_PE);
                    if($run_student_grades_term3_phase4_pe){
                    echo "added insert_term3_phase4_PE ";
                    }else{
                    echo "error insert_term3_phase4_PE". 
                    $conn->error;
                    }
                    
                    $insert_term3_phase4_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$health','$term3_phase4_health', '$term3_phase4', '$term3_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term3_phase4_health = mysqli_query($conn,$insert_term3_phase4_health);
                    if($run_student_grades_term3_phase4_health){
                    echo"added insert_term3_phase4_health";
                    }
                    else{
                    echo"error term3 phase 1 health". $conn->error; 
                    }
                    ...
                    $insert_phase4_term3_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase4_term3_general_average', '$term1_phase4','$term1_phase4_remarks', '$dateCreated','$dateUpdated')";
                    $run_phase4_term3_general_average = mysqli_query($conn,$insert_phase4_term3_general_average);
                    
                    if($run_phase4_term3_general_average){
                    echo "added student averages term3";
                    }else{
                    echo "added student averages term3";
                    }
                    ...
                    VALUES ('$lrn', '$mother_tongue','$term1_phase4_mother_tongue', '$term4_phase4', '$term4_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term4_phase4_mother_tongue = mysqli_query($conn,$insert_student_grades_term4_phase4_mother_tongue);
                    if($run_student_grades_4_phase4_mother_tongue){
                            echo "added insert_student_grades_term4_phase4_mother_tongue ";
                        }else{
                            echo "error insert_student_grades_term4_phase4_mother_tongue". $conn->error;
                        }
                    ...
                    VALUES ('$lrn', '$filipino','$term4_phase4_filipino', '$term4_phase4', '$term4_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term4_phase4_filipino = mysqli_query($conn,$insert_student_grades_term4_phase4_filipino);
                    if($run_student_grades_term4_phase4_filipino){
                         echo "added insert_student_grades_term4_phase4_filipino ";
                        }
                        else{
                         echo "error insert_student_grades_term4_phase4_filipino". $conn->error;
                        }
                    ...
                    VALUES ('$lrn', '$english','$term4_phase4_english', '$term4_phase4', '$term4_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term4_phase4_english = mysqli_query($conn,$insert_student_grades_term4_phase4_english);
                    if($run_student_grades_term4_phase4_english){
                    echo "added insert_student_grades_term4_phase4_english ";
                        }
                    else{
                        echo "error insert_student_grades_term4_phase4_english". $conn->error;
                        }
                    
                    //insert term4 phase 1 math
                    $insert_student_grades_term4_phase4_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$math','$term4_phase4_mathematics', '$term4_phase4', '$term4_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term4_phase4_mathematics = mysqli_query($conn,$insert_student_grades_term4_phase4_mathematics);
                    if($run_student_grades_term4_phase4_mathematics){
                    echo "added insert_student_grades_term4_phase4_mathematics ";
                        }
                    else{
                         echo "error insert_student_grades_term4_phase4_mathematics". $conn->error;
                        }
                    ...
                    VALUES ('$lrn', '$science','$term4_phase4_science', '$term4_phase4', '$term4_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term4_phase4_science = mysqli_query($conn,$insert_student_grades_term4_phase4_science);
                    if($run_student_grades_term4_phase4_science){
                         echo "added insert_student_grades_term4_phase4_science ";
                        }
                        else{
                        echo "error insert_student_grades_term4_phase4_science". $conn->error;
                        }
                    ...
                    VALUES ('$lrn', '$AP','$term4_phase4_araling_panlipunan', '$term4_phase4', '$term4_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term4_phase4_AP = mysqli_query($conn,$insert_student_grades_term4_phase4_AP);
                    if($run_student_grades_term4_phase4_AP){
                         echo "added insert_student_grades_term4_phase4_AP ";
                        }
                    else{
                          echo "error insert_student_grades_term4_phase4_AP". $conn->error;
                     }
                    ...
                    VALUES ('$lrn', '$epp_tle','$term4_phase4_epp_tle', '$term4_phase4', '$term4_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term4_phase4_epp_tle = mysqli_query($conn,$insert_student_grades_term4_phase4_epp_tle);
                    if($run_student_grades_term4_phase4_epp_tle){
                        echo "added insert_student_grades_term4_phase4_epp_tle ";
                        }
                    else{
                      echo "error insert_student_grades_term4_phase4_epp_tle". $conn->error;
                        }
                    
                    //insert term4 phase 1 mapeh
                    $insert_term4_phase4_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$mapeh','$term4_phase4_average_of_mapeh', '$term4_phase4', '$term4_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term4_phase4_mapeh = mysqli_query($conn,$run_student_grades_term4_phase4_mapeh);
                    if($run_student_grades_term4_phase4_epp_tle){
                    echo "added insert_term4_phase4_average_of_mapeh ";
                    }
                    else{
                     echo "error insert_term4_phase4_average_of_mapeh". $conn->error;
                        }
                    
                        
                    //insert term4 phase 1 mapeh
                    $insert_term4_phase4_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$music','$term4_phase4_music', '$term4_phase4', '$term4_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term4_phase4_music = mysqli_query($conn,$insert_term4_phase4_music);
                    if($run_student_grades_term4_phase4_music){
                         echo "added insert_term4_phase4_music ";
                      }
                      else{
                         echo "error insert_term4_phase4_music". $conn->error;
                        }
                    
                    //insert term4 phase 1 arts
                    $insert_term4_phase4_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$arts','$term4_phase4_arts', '$term4_phase4', '$term4_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term4_phase4_arts = mysqli_query($conn,$insert_term4_phase4_arts);
                    if($run_student_grades_term4_phase4_arts){
                    echo "added insert_term4_phase4_arts ";
                    }else{
                    echo "error insert_term4_phase4_arts". $conn->error;
                    }
                    
                    //insert term4 phase 1 PE
                    $insert_term4_phase4_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$PE','$term4_phase4_pe', '$term4_phase4', '$term4_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term4_phase4_pe = mysqli_query($conn,$insert_term4_phase4_PE);
                    if($run_student_grades_term4_phase4_pe){
                    echo "added insert_term4_phase4_PE ";
                    }else{
                    echo "error insert_term4_phase4_PE". 
                    $conn->error;
                    }
                    
                    $insert_term4_phase4_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                    VALUES ('$lrn', '$health','$term4_phase4_health', '$term4_phase4', '$term4_phase4_remarks','$dateCreated', '$dateUpdated')";
                    $run_student_grades_term4_phase4_health = mysqli_query($conn,$insert_term4_phase4_health);
                    if($run_student_grades_term4_phase4_health){
                    echo"added insert_term4_phase4_health";
                    }
                    else{
                    echo"error term4 phase 1 health". $conn->error; 
                    }
                    ...
                    if($run_student_grades_term4_phase4_islamic){
                         echo  "added term islamic" . '<br>';
                          ...
                          echo "error term4_phase4 islamic" . '<br>';
                            ...
                            // general average of phase 1 term 4 
                        $insert_phase4_term4_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase4_term4_general_average', '$term1_phase4','$term1_phase4_remarks', '$dateCreated','$dateUpdated')";
                    $run_phase4_term4_general_average = mysqli_query($conn,$insert_phase4_term4_general_average);
                    
                    if($run_phase4_term4_general_average){
                        echo "added student averages term4";
                    }else{
                        echo "added student averages term4";
                    }
                    ...
                    $insert_student_final_ratings_english = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                    VALUES ('$lrn', '$english','$phase4_final_rating_english', '$phase4_term5', '$phase4', '$phase4_final_rating_english', '$dateCreated' , '$dateUpdated')";
                    $run_student_final_ratings_english = mysqli_query($conn,$insert_student_final_ratings_english);
                    ...
                    $insert_student_final_ratings_math = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                    VALUES ('$lrn', '$math','$phase4_final_rating_math', '$phase4_term5', '$phase4', '$phase4_final_rating_math', '$dateCreated' , '$dateUpdated')";
                    $run_student_final_ratings_math = mysqli_query($conn,$insert_student_final_ratings_math);
                    ...
                    $insert_student_final_ratings_science = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                    VALUES ('$lrn', '$science','$phase4_final_rating_science', '$phase4_term5', '$phase4', '$phase4_final_rating_science', '$dateCreated' , '$dateUpdated')";
                    $run_student_final_ratings_science = mysqli_query($conn,$insert_student_final_ratings_science);
                    ...
                    $insert_student_final_ratings_AP = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                    VALUES ('$lrn', '$AP','$phase4_final_rating_AP', '$phase4_term5', '$phase4', '$phase4_final_rating_AP', '$dateCreated' , '$dateUpdated')";
                    $run_student_final_ratings_AP = mysqli_query($conn,$insert_student_final_ratings_AP);
                    ...
                    $insert_student_final_ratings_epp_tle = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                    VALUES ('$lrn', '$epp_tle','$phase4_final_rating_epp_tle', '$phase4_term5', '$phase4', '$phase4_final_rating_epp_tle', '$dateCreated' , '$dateUpdated')";
                    $run_student_final_ratings_epp_tle = mysqli_query($conn,$insert_student_final_ratings_epp_tle);
                    ...
                    $insert_student_final_ratings_mapeh = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                    VALUES ('$lrn', '$mapeh','$phase4_final_rating_mapeh', '$phase4_term5', '$phase4', '$phase4_final_rating_mapeh', '$dateCreated' , '$dateUpdated')";
                    $run_student_final_ratings_mapeh = mysqli_query($conn,$insert_student_final_ratings_mapeh);
                    ...
                    $insert_student_final_ratings_music = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                    VALUES ('$lrn', '$music','$phase4_final_rating_music', '$phase4_term5', '$phase4', '$phase4_final_rating_music', '$dateCreated' , '$dateUpdated')";
                    $run_student_final_ratings_music = mysqli_query($conn,$insert_student_final_ratings_music);
                    ...
                    $insert_student_final_ratings_arts = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                    VALUES ('$lrn', '$arts','$phase4_final_rating_arts', '$phase4_term5', '$phase4', '$phase4_final_rating_arts', '$dateCreated' , '$dateUpdated')";
                    $run_student_final_ratings_arts = mysqli_query($conn,$insert_student_final_ratings_arts);
                    ...
                    $insert_student_final_ratings_pe = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                    VALUES ('$lrn', '$PE','$phase4_final_rating_PE', '$phase4_term5', '$phase4', '$phase4_final_rating_PE', '$dateCreated' , '$dateUpdated')";
                    $run_student_final_ratings_pe = mysqli_query($conn,$insert_student_final_ratings_pe);
                    ...
                    $insert_student_final_ratings_health = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                    VALUES ('$lrn', '$health','$phase4_final_rating_health', '$phase4_term5', '$phase4', '$phase4_final_rating_health', '$dateCreated' , '$dateUpdated')";
                    $run_student_final_ratings_health = mysqli_query($conn,$insert_student_final_ratings_health);
                    ...
                    $insert_student_final_ratings_esp = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                    VALUES ('$lrn', '$esp', '$phase4_final_rating_esp','$phase4_term5', '$phase4', '$phase4_final_rating_esp', '$dateCreated' , '$dateUpdated')";
                    $run_student_final_ratings_esp = mysqli_query($conn,$insert_student_final_ratings_esp);
                    ...
                    $insert_student_final_ratings_arabic = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                    VALUES ('$lrn', '$arabic_language','$phase4_final_rating_arabic_language', '$phase4_term5', '$phase4', '$phase4_final_rating_arabic_language', '$dateCreated' , '$dateUpdated')";
                    $run_student_final_ratings_arabic = mysqli_query($conn,$insert_student_final_ratings_arabic);
                    ...
                    $insert_student_final_ratings_arabic = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                    VALUES ('$lrn', '$islamic_values','$phase4_final_rating_islamic_values', '$phase4_term5', '$phase4', '$phase4_final_rating_islamic_values_outpu', '$dateCreated' , '$dateUpdated')";
                    $run_student_final_ratings_arabic = mysqli_query($conn,$insert_student_final_ratings_arabic);
                    ...
                    if($run_student_final_ratings_arabic){
                        ...
                        //general averag of phase 1 term 5 
                    $insert_phase4_term5_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase4_term5_general_average', '$term1_phase4','$term1_phase4_remarks', '$dateCreated','$dateUpdated')";
                    ...
                    if($phase5_run_scholastic_records){
                        ...
                        if($run_student_grades_term1_phase5_islamic){
                             echo  "added term islamic" . '<br>';
                              ...
                              echo "error term1_phase5 islamic" . '<br>';
                                ...
                                //general average
                            $insert_phase5_term1_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn', '$phase5_term1_general_average', '$term1_phase5','$phase5_remarks','$dateCreated', '$dateUpdated')";
                        ...
                        VALUES ('$lrn', '$mother_tongue','$term1_phase5_mother_tongue', '$term2_phase5', '$term2_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term2_phase5_mother_tongue = mysqli_query($conn,$insert_student_grades_term2_phase5_mother_tongue);
                        if($run_student_grades_term2_phase5_mother_tongue){
                        echo "added insert_student_grades_term2_phase5_mother_tongue ";
                        }else{
                        echo "error insert_student_grades_term2_phase5_mother_tongue". $conn->error;
                        }
                        ...
                        VALUES ('$lrn', '$filipino','$term2_phase5_filipino', '$term2_phase5', '$term2_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term2_phase5_filipino = mysqli_query($conn,$insert_student_grades_term2_phase5_filipino);
                        if($run_student_grades_term2_phase5_filipino){
                        echo "added insert_student_grades_term2_phase5_filipino ";
                        }else{
                        echo "error insert_student_grades_term2_phase5_filipino". $conn->error;
                        }
                        ...
                        VALUES ('$lrn', '$english','$term2_phase5_english', '$term2_phase5', '$term2_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term2_phase5_english = mysqli_query($conn,$insert_student_grades_term2_phase5_english);
                        if($run_student_grades_term2_phase5_english){
                        echo "added insert_student_grades_term2_phase5_english ";
                        }else{
                        echo "error insert_student_grades_term2_phase5_english". $conn->error;
                        }
                        
                        //insert term2 phase 1 math
                        $insert_student_grades_term2_phase5_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$math','$term2_phase5_mathematics', '$term2_phase5', '$term2_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term2_phase5_mathematics = mysqli_query($conn,$insert_student_grades_term2_phase5_mathematics);
                        if($run_student_grades_term2_phase5_mathematics){
                        echo "added insert_student_grades_term1_phase5_mathematics ";
                        }else{
                        echo "error insert_student_grades_term1_phase5_mathematics". $conn->error;
                        }
                        ...
                        VALUES ('$lrn', '$science','$term2_phase5_science', '$term2_phase5', '$term2_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term2_phase5_science = mysqli_query($conn,$insert_student_grades_term2_phase5_science);
                        if($run_student_grades_term2_phase5_science){
                        echo "added insert_student_grades_term2_phase5_science ";
                        }else{
                        echo "error insert_student_grades_term2_phase5_science". $conn->error;
                        }
                        ...
                        VALUES ('$lrn', '$AP','$term2_phase5_araling_panlipunan', '$term2_phase5', '$term2_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term2_phase5_AP = mysqli_query($conn,$insert_student_grades_term2_phase5_AP);
                        if($run_student_grades_term2_phase5_AP){
                        echo "added insert_student_grades_term2_phase5_AP ";
                        }else{
                        echo "error insert_student_grades_term2_phase5_AP". $conn->error;
                        }
                        ...
                        VALUES ('$lrn', '$epp_tle','$term2_phase5_epp_tle', '$term2_phase5', '$term2_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term2_phase5_epp_tle = mysqli_query($conn,$insert_student_grades_term2_phase5_epp_tle);
                        if($run_student_grades_term2_phase5_epp_tle){
                        echo "added insert_student_grades_term2_phase5_epp_tle ";
                        }else{
                        echo "error insert_student_grades_term2_phase5_epp_tle". $conn->error;
                        }
                        
                        //insert term2 phase 1 mapeh
                        $insert_term2_phase5_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$mapeh','$term2_phase5_average_of_mapeh', '$term2_phase5', '$term2_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term2_phase5_mapeh = mysqli_query($conn,$run_student_grades_term2_phase5_mapeh);
                        if($run_student_grades_term2_phase5_epp_tle){
                        echo "added insert_term2_phase5_average_of_mapeh ";
                        }else{
                        echo "error insert_term2_phase5_average_of_mapeh". $conn->error;
                        }
                        
                        
                        //insert term2 phase 1 mapeh
                        $insert_term2_phase5_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$music','$term2_phase5_music', '$term2_phase5', '$term2_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term2_phase5_music = mysqli_query($conn,$insert_term2_phase5_music);
                        if($run_student_grades_term2_phase5_music){
                        echo "added insert_term2_phase5_music ";
                        }else{
                        echo "error insert_term2_phase5_music". $conn->error;
                        }
                        
                        //insert term2 phase 1 arts
                        $insert_term2_phase5_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$arts','$term2_phase5_arts', '$term2_phase5', '$term2_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term2_phase5_arts = mysqli_query($conn,$insert_term2_phase5_arts);
                        if($run_student_grades_term2_phase5_arts){
                        echo "added insert_term2_phase5_arts ";
                        }else{
                        echo "error insert_term2_phase5_arts". $conn->error;
                        }
                        
                        //insert term2 phase 1 PE
                        $insert_term2_phase5_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$PE','$term2_phase5_pe', '$term2_phase5', '$term2_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term2_phase5_pe = mysqli_query($conn,$insert_term2_phase5_PE);
                        if($run_student_grades_term2_phase5_pe){
                        echo "added insert_term2_phase5_PE ";
                        }else{
                        echo "error insert_term2_phase5_PE". 
                        $conn->error;
                        }
                        
                        $insert_term2_phase5_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$health','$term2_phase5_health', '$term2_phase5', '$term2_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term2_phase5_health = mysqli_query($conn,$insert_term2_phase5_health);
                        if($run_student_grades_term2_phase5_health){
                        echo"added insert_term2_phase5_health";
                        }
                        else{
                        echo"error term2 phase 1 health". $conn->error; 
                        }
                        ...
                        if($run_student_grades_term2_phase5_islamic){
                             echo  "added term islamic" . '<br>';
                              ...
                              echo "error term2_phase5 islamic" . '<br>';
                                ...
                                // general average of term 2
                        $insert_phase5_term2_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase5_term2_general_average', '$term1_phase5','$term1_phase5_remarks', '$dateCreated','$dateUpdated')";
                        $run_phase5_term2_general_average = mysqli_query($conn,$insert_phase5_term2_general_average);
                        
                         if($run_phase5_term2_general_average){
                                    echo "added student averages term2";
                         }else{
                              echo "error student averages term2";
                             }
                        ...
                        VALUES ('$lrn', '$mother_tongue','$term1_phase5_mother_tongue', '$term3_phase5', '$term3_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term3_phase5_mother_tongue = mysqli_query($conn,$insert_student_grades_term3_phase5_mother_tongue);
                        if($run_student_grades_3_phase5_mother_tongue){
                        echo "added insert_student_grades_term3_phase5_mother_tongue ";
                        }else{
                        echo "error insert_student_grades_term3_phase5_mother_tongue". $conn->error;
                        }
                        ...
                        VALUES ('$lrn', '$filipino','$term3_phase5_filipino', '$term3_phase5', '$term3_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term3_phase5_filipino = mysqli_query($conn,$insert_student_grades_term3_phase5_filipino);
                        if($run_student_grades_term3_phase5_filipino){
                        echo "added insert_student_grades_term3_phase5_filipino ";
                        }else{
                        echo "error insert_student_grades_term3_phase5_filipino". $conn->error;
                        }
                        ...
                        VALUES ('$lrn', '$english','$term3_phase5_english', '$term3_phase5', '$term3_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term3_phase5_english = mysqli_query($conn,$insert_student_grades_term3_phase5_english);
                        if($run_student_grades_term3_phase5_english){
                        echo "added insert_student_grades_term3_phase5_english ";
                        }else{
                        echo "error insert_student_grades_term3_phase5_english". $conn->error;
                        }
                        
                        //insert term3 phase 1 math
                        $insert_student_grades_term3_phase5_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$math','$term3_phase5_mathematics', '$term3_phase5', '$term3_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term3_phase5_mathematics = mysqli_query($conn,$insert_student_grades_term3_phase5_mathematics);
                        if($run_student_grades_term3_phase5_mathematics){
                        echo "added insert_student_grades_term3_phase5_mathematics ";
                        }else{
                        echo "error insert_student_grades_term3_phase5_mathematics". $conn->error;
                        }
                        ...
                        VALUES ('$lrn', '$science','$term3_phase5_science', '$term3_phase5', '$term3_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term3_phase5_science = mysqli_query($conn,$insert_student_grades_term3_phase5_science);
                        if($run_student_grades_term3_phase5_science){
                        echo "added insert_student_grades_term3_phase5_science ";
                        }else{
                        echo "error insert_student_grades_term3_phase5_science". $conn->error;
                        }
                        ...
                        VALUES ('$lrn', '$AP','$term3_phase5_araling_panlipunan', '$term3_phase5', '$term3_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term3_phase5_AP = mysqli_query($conn,$insert_student_grades_term3_phase5_AP);
                        if($run_student_grades_term3_phase5_AP){
                        echo "added insert_student_grades_term3_phase5_AP ";
                        }else{
                        echo "error insert_student_grades_term3_phase5_AP". $conn->error;
                        }
                        ...
                        VALUES ('$lrn', '$epp_tle','$term3_phase5_epp_tle', '$term3_phase5', '$term3_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term3_phase5_epp_tle = mysqli_query($conn,$insert_student_grades_term3_phase5_epp_tle);
                        if($run_student_grades_term3_phase5_epp_tle){
                        echo "added insert_student_grades_term3_phase5_epp_tle ";
                        }else{
                        echo "error insert_student_grades_term3_phase5_epp_tle". $conn->error;
                        }
                        
                        //insert term3 phase 1 mapeh
                        $insert_term3_phase5_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$mapeh','$term3_phase5_average_of_mapeh', '$term3_phase5', '$term3_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term3_phase5_mapeh = mysqli_query($conn,$run_student_grades_term3_phase5_mapeh);
                        if($run_student_grades_term3_phase5_epp_tle){
                        echo "added insert_term3_phase5_average_of_mapeh ";
                        }else{
                        echo "error insert_term3_phase5_average_of_mapeh". $conn->error;
                        }
                        
                        
                        //insert term3 phase 1 mapeh
                        $insert_term3_phase5_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$music','$term3_phase5_music', '$term3_phase5', '$term3_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term3_phase5_music = mysqli_query($conn,$insert_term3_phase5_music);
                        if($run_student_grades_term3_phase5_music){
                        echo "added insert_term3_phase5_music ";
                        }else{
                        echo "error insert_term3_phase5_music". $conn->error;
                        }
                        
                        //insert term3 phase 1 arts
                        $insert_term3_phase5_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$arts','$term3_phase5_arts', '$term3_phase5', '$term3_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term3_phase5_arts = mysqli_query($conn,$insert_term3_phase5_arts);
                        if($run_student_grades_term3_phase5_arts){
                        echo "added insert_term3_phase5_arts ";
                        }else{
                        echo "error insert_term3_phase5_arts". $conn->error;
                        }
                        
                        //insert term3 phase 1 PE
                        $insert_term3_phase5_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$PE','$term3_phase5_pe', '$term3_phase5', '$term3_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term3_phase5_pe = mysqli_query($conn,$insert_term3_phase5_PE);
                        if($run_student_grades_term3_phase5_pe){
                        echo "added insert_term3_phase5_PE ";
                        }else{
                        echo "error insert_term3_phase5_PE". 
                        $conn->error;
                        }
                        
                        $insert_term3_phase5_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$health','$term3_phase5_health', '$term3_phase5', '$term3_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term3_phase5_health = mysqli_query($conn,$insert_term3_phase5_health);
                        if($run_student_grades_term3_phase5_health){
                        echo"added insert_term3_phase5_health";
                        }
                        else{
                        echo"error term3 phase 1 health". $conn->error; 
                        }
                        ...
                        $insert_phase5_term3_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase5_term3_general_average', '$term1_phase5','$term1_phase5_remarks', '$dateCreated','$dateUpdated')";
                        $run_phase5_term3_general_average = mysqli_query($conn,$insert_phase5_term3_general_average);
                        
                        if($run_phase5_term3_general_average){
                        echo "added student averages term3";
                        }else{
                        echo "added student averages term3";
                        }
                        ...
                        VALUES ('$lrn', '$mother_tongue','$term1_phase5_mother_tongue', '$term4_phase5', '$term4_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term4_phase5_mother_tongue = mysqli_query($conn,$insert_student_grades_term4_phase5_mother_tongue);
                        if($run_student_grades_4_phase5_mother_tongue){
                                echo "added insert_student_grades_term4_phase5_mother_tongue ";
                            }else{
                                echo "error insert_student_grades_term4_phase5_mother_tongue". $conn->error;
                            }
                        ...
                        VALUES ('$lrn', '$filipino','$term4_phase5_filipino', '$term4_phase5', '$term4_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term4_phase5_filipino = mysqli_query($conn,$insert_student_grades_term4_phase5_filipino);
                        if($run_student_grades_term4_phase5_filipino){
                             echo "added insert_student_grades_term4_phase5_filipino ";
                            }
                            else{
                             echo "error insert_student_grades_term4_phase5_filipino". $conn->error;
                            }
                        ...
                        VALUES ('$lrn', '$english','$term4_phase5_english', '$term4_phase5', '$term4_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term4_phase5_english = mysqli_query($conn,$insert_student_grades_term4_phase5_english);
                        if($run_student_grades_term4_phase5_english){
                        echo "added insert_student_grades_term4_phase5_english ";
                            }
                        else{
                            echo "error insert_student_grades_term4_phase5_english". $conn->error;
                            }
                        
                        //insert term4 phase 1 math
                        $insert_student_grades_term4_phase5_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$math','$term4_phase5_mathematics', '$term4_phase5', '$term4_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term4_phase5_mathematics = mysqli_query($conn,$insert_student_grades_term4_phase5_mathematics);
                        if($run_student_grades_term4_phase5_mathematics){
                        echo "added insert_student_grades_term4_phase5_mathematics ";
                            }
                        else{
                             echo "error insert_student_grades_term4_phase5_mathematics". $conn->error;
                            }
                        ...
                        VALUES ('$lrn', '$science','$term4_phase5_science', '$term4_phase5', '$term4_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term4_phase5_science = mysqli_query($conn,$insert_student_grades_term4_phase5_science);
                        if($run_student_grades_term4_phase5_science){
                             echo "added insert_student_grades_term4_phase5_science ";
                            }
                            else{
                            echo "error insert_student_grades_term4_phase5_science". $conn->error;
                            }
                        ...
                        VALUES ('$lrn', '$AP','$term4_phase5_araling_panlipunan', '$term4_phase5', '$term4_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term4_phase5_AP = mysqli_query($conn,$insert_student_grades_term4_phase5_AP);
                        if($run_student_grades_term4_phase5_AP){
                             echo "added insert_student_grades_term4_phase5_AP ";
                            }
                        else{
                              echo "error insert_student_grades_term4_phase5_AP". $conn->error;
                         }
                        ...
                        VALUES ('$lrn', '$epp_tle','$term4_phase5_epp_tle', '$term4_phase5', '$term4_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term4_phase5_epp_tle = mysqli_query($conn,$insert_student_grades_term4_phase5_epp_tle);
                        if($run_student_grades_term4_phase5_epp_tle){
                            echo "added insert_student_grades_term4_phase5_epp_tle ";
                            }
                        else{
                          echo "error insert_student_grades_term4_phase5_epp_tle". $conn->error;
                            }
                        
                        //insert term4 phase 1 mapeh
                        $insert_term4_phase5_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$mapeh','$term4_phase5_average_of_mapeh', '$term4_phase5', '$term4_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term4_phase5_mapeh = mysqli_query($conn,$run_student_grades_term4_phase5_mapeh);
                        if($run_student_grades_term4_phase5_epp_tle){
                        echo "added insert_term4_phase5_average_of_mapeh ";
                        }
                        else{
                         echo "error insert_term4_phase5_average_of_mapeh". $conn->error;
                            }
                        
                            
                        //insert term4 phase 1 mapeh
                        $insert_term4_phase5_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$music','$term4_phase5_music', '$term4_phase5', '$term4_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term4_phase5_music = mysqli_query($conn,$insert_term4_phase5_music);
                        if($run_student_grades_term4_phase5_music){
                             echo "added insert_term4_phase5_music ";
                          }
                          else{
                             echo "error insert_term4_phase5_music". $conn->error;
                            }
                        
                        //insert term4 phase 1 arts
                        $insert_term4_phase5_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$arts','$term4_phase5_arts', '$term4_phase5', '$term4_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term4_phase5_arts = mysqli_query($conn,$insert_term4_phase5_arts);
                        if($run_student_grades_term4_phase5_arts){
                        echo "added insert_term4_phase5_arts ";
                        }else{
                        echo "error insert_term4_phase5_arts". $conn->error;
                        }
                        
                        //insert term4 phase 1 PE
                        $insert_term4_phase5_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$PE','$term4_phase5_pe', '$term4_phase5', '$term4_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term4_phase5_pe = mysqli_query($conn,$insert_term4_phase5_PE);
                        if($run_student_grades_term4_phase5_pe){
                        echo "added insert_term4_phase5_PE ";
                        }else{
                        echo "error insert_term4_phase5_PE". 
                        $conn->error;
                        }
                        
                        $insert_term4_phase5_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                        VALUES ('$lrn', '$health','$term4_phase5_health', '$term4_phase5', '$term4_phase5_remarks','$dateCreated', '$dateUpdated')";
                        $run_student_grades_term4_phase5_health = mysqli_query($conn,$insert_term4_phase5_health);
                        if($run_student_grades_term4_phase5_health){
                        echo"added insert_term4_phase5_health";
                        }
                        else{
                        echo"error term4 phase 1 health". $conn->error; 
                        }
                        ...
                        if($run_student_grades_term4_phase5_islamic){
                             echo  "added term islamic" . '<br>';
                              ...
                              echo "error term4_phase5 islamic" . '<br>';
                                ...
                                // general average of phase 1 term 4 
                            $insert_phase5_term4_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase5_term4_general_average', '$term1_phase5','$term1_phase5_remarks', '$dateCreated','$dateUpdated')";
                        $run_phase5_term4_general_average = mysqli_query($conn,$insert_phase5_term4_general_average);
                        
                        if($run_phase5_term4_general_average){
                            echo "added student averages term4";
                        }else{
                            echo "added student averages term4";
                        }
                        ...
                        $insert_student_final_ratings_english = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                        VALUES ('$lrn', '$english','$phase5_final_rating_english', '$phase5_term5', '$phase5', '$phase5_final_rating_english', '$dateCreated' , '$dateUpdated')";
                        $run_student_final_ratings_english = mysqli_query($conn,$insert_student_final_ratings_english);
                        ...
                        $insert_student_final_ratings_math = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                        VALUES ('$lrn', '$math','$phase5_final_rating_math', '$phase5_term5', '$phase5', '$phase5_final_rating_math', '$dateCreated' , '$dateUpdated')";
                        $run_student_final_ratings_math = mysqli_query($conn,$insert_student_final_ratings_math);
                        ...
                        $insert_student_final_ratings_science = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                        VALUES ('$lrn', '$science','$phase5_final_rating_science', '$phase5_term5', '$phase5', '$phase5_final_rating_science', '$dateCreated' , '$dateUpdated')";
                        $run_student_final_ratings_science = mysqli_query($conn,$insert_student_final_ratings_science);
                        ...
                        $insert_student_final_ratings_AP = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                        VALUES ('$lrn', '$AP','$phase5_final_rating_AP', '$phase5_term5', '$phase5', '$phase5_final_rating_AP', '$dateCreated' , '$dateUpdated')";
                        $run_student_final_ratings_AP = mysqli_query($conn,$insert_student_final_ratings_AP);
                        ...
                        $insert_student_final_ratings_epp_tle = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                        VALUES ('$lrn', '$epp_tle','$phase5_final_rating_epp_tle', '$phase5_term5', '$phase5', '$phase5_final_rating_epp_tle', '$dateCreated' , '$dateUpdated')";
                        $run_student_final_ratings_epp_tle = mysqli_query($conn,$insert_student_final_ratings_epp_tle);
                        ...
                        $insert_student_final_ratings_mapeh = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                        VALUES ('$lrn', '$mapeh','$phase5_final_rating_mapeh', '$phase5_term5', '$phase5', '$phase5_final_rating_mapeh', '$dateCreated' , '$dateUpdated')";
                        $run_student_final_ratings_mapeh = mysqli_query($conn,$insert_student_final_ratings_mapeh);
                        ...
                        $insert_student_final_ratings_music = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                        VALUES ('$lrn', '$music','$phase5_final_rating_music', '$phase5_term5', '$phase5', '$phase5_final_rating_music', '$dateCreated' , '$dateUpdated')";
                        $run_student_final_ratings_music = mysqli_query($conn,$insert_student_final_ratings_music);
                        ...
                        $insert_student_final_ratings_arts = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                        VALUES ('$lrn', '$arts','$phase5_final_rating_arts', '$phase5_term5', '$phase5', '$phase5_final_rating_arts', '$dateCreated' , '$dateUpdated')";
                        $run_student_final_ratings_arts = mysqli_query($conn,$insert_student_final_ratings_arts);
                        ...
                        $insert_student_final_ratings_pe = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                        VALUES ('$lrn', '$PE','$phase5_final_rating_PE', '$phase5_term5', '$phase5', '$phase5_final_rating_PE', '$dateCreated' , '$dateUpdated')";
                        $run_student_final_ratings_pe = mysqli_query($conn,$insert_student_final_ratings_pe);
                        ...
                        $insert_student_final_ratings_health = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                        VALUES ('$lrn', '$health','$phase5_final_rating_health', '$phase5_term5', '$phase5', '$phase5_final_rating_health', '$dateCreated' , '$dateUpdated')";
                        $run_student_final_ratings_health = mysqli_query($conn,$insert_student_final_ratings_health);
                        ...
                        $insert_student_final_ratings_esp = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                        VALUES ('$lrn', '$esp', '$phase5_final_rating_esp','$phase5_term5', '$phase5', '$phase5_final_rating_esp', '$dateCreated' , '$dateUpdated')";
                        $run_student_final_ratings_esp = mysqli_query($conn,$insert_student_final_ratings_esp);
                        ...
                        $insert_student_final_ratings_arabic = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                        VALUES ('$lrn', '$arabic_language','$phase5_final_rating_arabic_language', '$phase5_term5', '$phase5', '$phase5_final_rating_arabic_language', '$dateCreated' , '$dateUpdated')";
                        $run_student_final_ratings_arabic = mysqli_query($conn,$insert_student_final_ratings_arabic);
                        ...
                        $insert_student_final_ratings_arabic = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                        VALUES ('$lrn', '$islamic_values','$phase5_final_rating_islamic_values', '$phase5_term5', '$phase5', '$phase5_final_rating_islamic_values_outpu', '$dateCreated' , '$dateUpdated')";
                        $run_student_final_ratings_arabic = mysqli_query($conn,$insert_student_final_ratings_arabic);
                        ...
                        if($run_student_final_ratings_arabic){
                            ...
                            //general averag of phase 1 term 5 
                        $insert_phase5_term5_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase5_term5_general_average', '$term1_phase5','$term1_phase5_remarks', '$dateCreated','$dateUpdated')";
                        ...
                        if($phase6_run_scholastic_records){
                            ...
                            if($run_student_grades_term1_phase6_islamic){
                                 echo  "added term islamic" . '<br>';
                                  ...
                                  echo "error term1_phase6 islamic" . '<br>';
                                    ...
                                    //general average
                                $insert_phase6_term1_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn', '$phase6_term1_general_average', '$term1_phase6','$phase6_remarks','$dateCreated', '$dateUpdated')";
                            ...
                            VALUES ('$lrn', '$mother_tongue','$term1_phase6_mother_tongue', '$term2_phase6', '$term2_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term2_phase6_mother_tongue = mysqli_query($conn,$insert_student_grades_term2_phase6_mother_tongue);
                            if($run_student_grades_term2_phase6_mother_tongue){
                            echo "added insert_student_grades_term2_phase6_mother_tongue ";
                            }else{
                            echo "error insert_student_grades_term2_phase6_mother_tongue". $conn->error;
                            }
                            ...
                            VALUES ('$lrn', '$filipino','$term2_phase6_filipino', '$term2_phase6', '$term2_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term2_phase6_filipino = mysqli_query($conn,$insert_student_grades_term2_phase6_filipino);
                            if($run_student_grades_term2_phase6_filipino){
                            echo "added insert_student_grades_term2_phase6_filipino ";
                            }else{
                            echo "error insert_student_grades_term2_phase6_filipino". $conn->error;
                            }
                            ...
                            VALUES ('$lrn', '$english','$term2_phase6_english', '$term2_phase6', '$term2_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term2_phase6_english = mysqli_query($conn,$insert_student_grades_term2_phase6_english);
                            if($run_student_grades_term2_phase6_english){
                            echo "added insert_student_grades_term2_phase6_english ";
                            }else{
                            echo "error insert_student_grades_term2_phase6_english". $conn->error;
                            }
                            
                            //insert term2 phase 1 math
                            $insert_student_grades_term2_phase6_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$math','$term2_phase6_mathematics', '$term2_phase6', '$term2_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term2_phase6_mathematics = mysqli_query($conn,$insert_student_grades_term2_phase6_mathematics);
                            if($run_student_grades_term2_phase6_mathematics){
                            echo "added insert_student_grades_term1_phase6_mathematics ";
                            }else{
                            echo "error insert_student_grades_term1_phase6_mathematics". $conn->error;
                            }
                            ...
                            VALUES ('$lrn', '$science','$term2_phase6_science', '$term2_phase6', '$term2_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term2_phase6_science = mysqli_query($conn,$insert_student_grades_term2_phase6_science);
                            if($run_student_grades_term2_phase6_science){
                            echo "added insert_student_grades_term2_phase6_science ";
                            }else{
                            echo "error insert_student_grades_term2_phase6_science". $conn->error;
                            }
                            ...
                            VALUES ('$lrn', '$AP','$term2_phase6_araling_panlipunan', '$term2_phase6', '$term2_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term2_phase6_AP = mysqli_query($conn,$insert_student_grades_term2_phase6_AP);
                            if($run_student_grades_term2_phase6_AP){
                            echo "added insert_student_grades_term2_phase6_AP ";
                            }else{
                            echo "error insert_student_grades_term2_phase6_AP". $conn->error;
                            }
                            ...
                            VALUES ('$lrn', '$epp_tle','$term2_phase6_epp_tle', '$term2_phase6', '$term2_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term2_phase6_epp_tle = mysqli_query($conn,$insert_student_grades_term2_phase6_epp_tle);
                            if($run_student_grades_term2_phase6_epp_tle){
                            echo "added insert_student_grades_term2_phase6_epp_tle ";
                            }else{
                            echo "error insert_student_grades_term2_phase6_epp_tle". $conn->error;
                            }
                            
                            //insert term2 phase 1 mapeh
                            $insert_term2_phase6_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$mapeh','$term2_phase6_average_of_mapeh', '$term2_phase6', '$term2_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term2_phase6_mapeh = mysqli_query($conn,$run_student_grades_term2_phase6_mapeh);
                            if($run_student_grades_term2_phase6_epp_tle){
                            echo "added insert_term2_phase6_average_of_mapeh ";
                            }else{
                            echo "error insert_term2_phase6_average_of_mapeh". $conn->error;
                            }
                            
                            
                            //insert term2 phase 1 mapeh
                            $insert_term2_phase6_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$music','$term2_phase6_music', '$term2_phase6', '$term2_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term2_phase6_music = mysqli_query($conn,$insert_term2_phase6_music);
                            if($run_student_grades_term2_phase6_music){
                            echo "added insert_term2_phase6_music ";
                            }else{
                            echo "error insert_term2_phase6_music". $conn->error;
                            }
                            
                            //insert term2 phase 1 arts
                            $insert_term2_phase6_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$arts','$term2_phase6_arts', '$term2_phase6', '$term2_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term2_phase6_arts = mysqli_query($conn,$insert_term2_phase6_arts);
                            if($run_student_grades_term2_phase6_arts){
                            echo "added insert_term2_phase6_arts ";
                            }else{
                            echo "error insert_term2_phase6_arts". $conn->error;
                            }
                            
                            //insert term2 phase 1 PE
                            $insert_term2_phase6_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$PE','$term2_phase6_pe', '$term2_phase6', '$term2_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term2_phase6_pe = mysqli_query($conn,$insert_term2_phase6_PE);
                            if($run_student_grades_term2_phase6_pe){
                            echo "added insert_term2_phase6_PE ";
                            }else{
                            echo "error insert_term2_phase6_PE". 
                            $conn->error;
                            }
                            
                            $insert_term2_phase6_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$health','$term2_phase6_health', '$term2_phase6', '$term2_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term2_phase6_health = mysqli_query($conn,$insert_term2_phase6_health);
                            if($run_student_grades_term2_phase6_health){
                            echo"added insert_term2_phase6_health";
                            }
                            else{
                            echo"error term2 phase 1 health". $conn->error; 
                            }
                            ...
                            if($run_student_grades_term2_phase6_islamic){
                                 echo  "added term islamic" . '<br>';
                                  ...
                                  echo "error term2_phase6 islamic" . '<br>';
                                    ...
                                    // general average of term 2
                            $insert_phase6_term2_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase6_term2_general_average', '$term1_phase6','$term1_phase6_remarks', '$dateCreated','$dateUpdated')";
                            $run_phase6_term2_general_average = mysqli_query($conn,$insert_phase6_term2_general_average);
                            
                             if($run_phase6_term2_general_average){
                                        echo "added student averages term2";
                             }else{
                                  echo "error student averages term2";
                                 }
                            ...
                            VALUES ('$lrn', '$mother_tongue','$term1_phase6_mother_tongue', '$term3_phase6', '$term3_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term3_phase6_mother_tongue = mysqli_query($conn,$insert_student_grades_term3_phase6_mother_tongue);
                            if($run_student_grades_3_phase6_mother_tongue){
                            echo "added insert_student_grades_term3_phase6_mother_tongue ";
                            }else{
                            echo "error insert_student_grades_term3_phase6_mother_tongue". $conn->error;
                            }
                            ...
                            VALUES ('$lrn', '$filipino','$term3_phase6_filipino', '$term3_phase6', '$term3_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term3_phase6_filipino = mysqli_query($conn,$insert_student_grades_term3_phase6_filipino);
                            if($run_student_grades_term3_phase6_filipino){
                            echo "added insert_student_grades_term3_phase6_filipino ";
                            }else{
                            echo "error insert_student_grades_term3_phase6_filipino". $conn->error;
                            }
                            ...
                            VALUES ('$lrn', '$english','$term3_phase6_english', '$term3_phase6', '$term3_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term3_phase6_english = mysqli_query($conn,$insert_student_grades_term3_phase6_english);
                            if($run_student_grades_term3_phase6_english){
                            echo "added insert_student_grades_term3_phase6_english ";
                            }else{
                            echo "error insert_student_grades_term3_phase6_english". $conn->error;
                            }
                            
                            //insert term3 phase 1 math
                            $insert_student_grades_term3_phase6_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$math','$term3_phase6_mathematics', '$term3_phase6', '$term3_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term3_phase6_mathematics = mysqli_query($conn,$insert_student_grades_term3_phase6_mathematics);
                            if($run_student_grades_term3_phase6_mathematics){
                            echo "added insert_student_grades_term3_phase6_mathematics ";
                            }else{
                            echo "error insert_student_grades_term3_phase6_mathematics". $conn->error;
                            }
                            ...
                            VALUES ('$lrn', '$science','$term3_phase6_science', '$term3_phase6', '$term3_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term3_phase6_science = mysqli_query($conn,$insert_student_grades_term3_phase6_science);
                            if($run_student_grades_term3_phase6_science){
                            echo "added insert_student_grades_term3_phase6_science ";
                            }else{
                            echo "error insert_student_grades_term3_phase6_science". $conn->error;
                            }
                            ...
                            VALUES ('$lrn', '$AP','$term3_phase6_araling_panlipunan', '$term3_phase6', '$term3_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term3_phase6_AP = mysqli_query($conn,$insert_student_grades_term3_phase6_AP);
                            if($run_student_grades_term3_phase6_AP){
                            echo "added insert_student_grades_term3_phase6_AP ";
                            }else{
                            echo "error insert_student_grades_term3_phase6_AP". $conn->error;
                            }
                            ...
                            VALUES ('$lrn', '$epp_tle','$term3_phase6_epp_tle', '$term3_phase6', '$term3_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term3_phase6_epp_tle = mysqli_query($conn,$insert_student_grades_term3_phase6_epp_tle);
                            if($run_student_grades_term3_phase6_epp_tle){
                            echo "added insert_student_grades_term3_phase6_epp_tle ";
                            }else{
                            echo "error insert_student_grades_term3_phase6_epp_tle". $conn->error;
                            }
                            
                            //insert term3 phase 1 mapeh
                            $insert_term3_phase6_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$mapeh','$term3_phase6_average_of_mapeh', '$term3_phase6', '$term3_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term3_phase6_mapeh = mysqli_query($conn,$run_student_grades_term3_phase6_mapeh);
                            if($run_student_grades_term3_phase6_epp_tle){
                            echo "added insert_term3_phase6_average_of_mapeh ";
                            }else{
                            echo "error insert_term3_phase6_average_of_mapeh". $conn->error;
                            }
                            
                            
                            //insert term3 phase 1 mapeh
                            $insert_term3_phase6_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$music','$term3_phase6_music', '$term3_phase6', '$term3_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term3_phase6_music = mysqli_query($conn,$insert_term3_phase6_music);
                            if($run_student_grades_term3_phase6_music){
                            echo "added insert_term3_phase6_music ";
                            }else{
                            echo "error insert_term3_phase6_music". $conn->error;
                            }
                            
                            //insert term3 phase 1 arts
                            $insert_term3_phase6_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$arts','$term3_phase6_arts', '$term3_phase6', '$term3_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term3_phase6_arts = mysqli_query($conn,$insert_term3_phase6_arts);
                            if($run_student_grades_term3_phase6_arts){
                            echo "added insert_term3_phase6_arts ";
                            }else{
                            echo "error insert_term3_phase6_arts". $conn->error;
                            }
                            
                            //insert term3 phase 1 PE
                            $insert_term3_phase6_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$PE','$term3_phase6_pe', '$term3_phase6', '$term3_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term3_phase6_pe = mysqli_query($conn,$insert_term3_phase6_PE);
                            if($run_student_grades_term3_phase6_pe){
                            echo "added insert_term3_phase6_PE ";
                            }else{
                            echo "error insert_term3_phase6_PE". 
                            $conn->error;
                            }
                            
                            $insert_term3_phase6_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$health','$term3_phase6_health', '$term3_phase6', '$term3_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term3_phase6_health = mysqli_query($conn,$insert_term3_phase6_health);
                            if($run_student_grades_term3_phase6_health){
                            echo"added insert_term3_phase6_health";
                            }
                            else{
                            echo"error term3 phase 1 health". $conn->error; 
                            }
                            ...
                            $insert_phase6_term3_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase6_term3_general_average', '$term1_phase6','$term1_phase6_remarks', '$dateCreated','$dateUpdated')";
                            $run_phase6_term3_general_average = mysqli_query($conn,$insert_phase6_term3_general_average);
                            
                            if($run_phase6_term3_general_average){
                            echo "added student averages term3";
                            }else{
                            echo "added student averages term3";
                            }
                            ...
                            VALUES ('$lrn', '$mother_tongue','$term1_phase6_mother_tongue', '$term4_phase6', '$term4_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term4_phase6_mother_tongue = mysqli_query($conn,$insert_student_grades_term4_phase6_mother_tongue);
                            if($run_student_grades_4_phase6_mother_tongue){
                                    echo "added insert_student_grades_term4_phase6_mother_tongue ";
                                }else{
                                    echo "error insert_student_grades_term4_phase6_mother_tongue". $conn->error;
                                }
                            ...
                            VALUES ('$lrn', '$filipino','$term4_phase6_filipino', '$term4_phase6', '$term4_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term4_phase6_filipino = mysqli_query($conn,$insert_student_grades_term4_phase6_filipino);
                            if($run_student_grades_term4_phase6_filipino){
                                 echo "added insert_student_grades_term4_phase6_filipino ";
                                }
                                else{
                                 echo "error insert_student_grades_term4_phase6_filipino". $conn->error;
                                }
                            ...
                            VALUES ('$lrn', '$english','$term4_phase6_english', '$term4_phase6', '$term4_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term4_phase6_english = mysqli_query($conn,$insert_student_grades_term4_phase6_english);
                            if($run_student_grades_term4_phase6_english){
                            echo "added insert_student_grades_term4_phase6_english ";
                                }
                            else{
                                echo "error insert_student_grades_term4_phase6_english". $conn->error;
                                }
                            
                            //insert term4 phase 1 math
                            $insert_student_grades_term4_phase6_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$math','$term4_phase6_mathematics', '$term4_phase6', '$term4_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term4_phase6_mathematics = mysqli_query($conn,$insert_student_grades_term4_phase6_mathematics);
                            if($run_student_grades_term4_phase6_mathematics){
                            echo "added insert_student_grades_term4_phase6_mathematics ";
                                }
                            else{
                                 echo "error insert_student_grades_term4_phase6_mathematics". $conn->error;
                                }
                            ...
                            VALUES ('$lrn', '$science','$term4_phase6_science', '$term4_phase6', '$term4_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term4_phase6_science = mysqli_query($conn,$insert_student_grades_term4_phase6_science);
                            if($run_student_grades_term4_phase6_science){
                                 echo "added insert_student_grades_term4_phase6_science ";
                                }
                                else{
                                echo "error insert_student_grades_term4_phase6_science". $conn->error;
                                }
                            ...
                            VALUES ('$lrn', '$AP','$term4_phase6_araling_panlipunan', '$term4_phase6', '$term4_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term4_phase6_AP = mysqli_query($conn,$insert_student_grades_term4_phase6_AP);
                            if($run_student_grades_term4_phase6_AP){
                                 echo "added insert_student_grades_term4_phase6_AP ";
                                }
                            else{
                                  echo "error insert_student_grades_term4_phase6_AP". $conn->error;
                             }
                            ...
                            VALUES ('$lrn', '$epp_tle','$term4_phase6_epp_tle', '$term4_phase6', '$term4_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term4_phase6_epp_tle = mysqli_query($conn,$insert_student_grades_term4_phase6_epp_tle);
                            if($run_student_grades_term4_phase6_epp_tle){
                                echo "added insert_student_grades_term4_phase6_epp_tle ";
                                }
                            else{
                              echo "error insert_student_grades_term4_phase6_epp_tle". $conn->error;
                                }
                            
                            //insert term4 phase 1 mapeh
                            $insert_term4_phase6_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$mapeh','$term4_phase6_average_of_mapeh', '$term4_phase6', '$term4_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term4_phase6_mapeh = mysqli_query($conn,$run_student_grades_term4_phase6_mapeh);
                            if($run_student_grades_term4_phase6_epp_tle){
                            echo "added insert_term4_phase6_average_of_mapeh ";
                            }
                            else{
                             echo "error insert_term4_phase6_average_of_mapeh". $conn->error;
                                }
                            
                                
                            //insert term4 phase 1 mapeh
                            $insert_term4_phase6_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$music','$term4_phase6_music', '$term4_phase6', '$term4_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term4_phase6_music = mysqli_query($conn,$insert_term4_phase6_music);
                            if($run_student_grades_term4_phase6_music){
                                 echo "added insert_term4_phase6_music ";
                              }
                              else{
                                 echo "error insert_term4_phase6_music". $conn->error;
                                }
                            
                            //insert term4 phase 1 arts
                            $insert_term4_phase6_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$arts','$term4_phase6_arts', '$term4_phase6', '$term4_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term4_phase6_arts = mysqli_query($conn,$insert_term4_phase6_arts);
                            if($run_student_grades_term4_phase6_arts){
                            echo "added insert_term4_phase6_arts ";
                            }else{
                            echo "error insert_term4_phase6_arts". $conn->error;
                            }
                            
                            //insert term4 phase 1 PE
                            $insert_term4_phase6_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$PE','$term4_phase6_pe', '$term4_phase6', '$term4_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term4_phase6_pe = mysqli_query($conn,$insert_term4_phase6_PE);
                            if($run_student_grades_term4_phase6_pe){
                            echo "added insert_term4_phase6_PE ";
                            }else{
                            echo "error insert_term4_phase6_PE". 
                            $conn->error;
                            }
                            
                            $insert_term4_phase6_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                            VALUES ('$lrn', '$health','$term4_phase6_health', '$term4_phase6', '$term4_phase6_remarks','$dateCreated', '$dateUpdated')";
                            $run_student_grades_term4_phase6_health = mysqli_query($conn,$insert_term4_phase6_health);
                            if($run_student_grades_term4_phase6_health){
                            echo"added insert_term4_phase6_health";
                            }
                            else{
                            echo"error term4 phase 1 health". $conn->error; 
                            }
                            ...
                            if($run_student_grades_term4_phase6_islamic){
                                 echo  "added term islamic" . '<br>';
                                  ...
                                  echo "error term4_phase6 islamic" . '<br>';
                                    ...
                                    // general average of phase 1 term 4 
                                $insert_phase6_term4_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase6_term4_general_average', '$term1_phase6','$term1_phase6_remarks', '$dateCreated','$dateUpdated')";
                            $run_phase6_term4_general_average = mysqli_query($conn,$insert_phase6_term4_general_average);
                            
                            if($run_phase6_term4_general_average){
                                echo "added student averages term4";
                            }else{
                                echo "added student averages term4";
                            }
                            ...
                            $insert_student_final_ratings_english = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                            VALUES ('$lrn', '$english','$phase6_final_rating_english', '$phase6_term5', '$phase6', '$phase6_final_rating_english', '$dateCreated' , '$dateUpdated')";
                            $run_student_final_ratings_english = mysqli_query($conn,$insert_student_final_ratings_english);
                            ...
                            $insert_student_final_ratings_math = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                            VALUES ('$lrn', '$math','$phase6_final_rating_math', '$phase6_term5', '$phase6', '$phase6_final_rating_math', '$dateCreated' , '$dateUpdated')";
                            $run_student_final_ratings_math = mysqli_query($conn,$insert_student_final_ratings_math);
                            ...
                            $insert_student_final_ratings_science = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                            VALUES ('$lrn', '$science','$phase6_final_rating_science', '$phase6_term5', '$phase6', '$phase6_final_rating_science', '$dateCreated' , '$dateUpdated')";
                            $run_student_final_ratings_science = mysqli_query($conn,$insert_student_final_ratings_science);
                            ...
                            $insert_student_final_ratings_AP = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                            VALUES ('$lrn', '$AP','$phase6_final_rating_AP', '$phase6_term5', '$phase6', '$phase6_final_rating_AP', '$dateCreated' , '$dateUpdated')";
                            $run_student_final_ratings_AP = mysqli_query($conn,$insert_student_final_ratings_AP);
                            ...
                            $insert_student_final_ratings_epp_tle = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                            VALUES ('$lrn', '$epp_tle','$phase6_final_rating_epp_tle', '$phase6_term5', '$phase6', '$phase6_final_rating_epp_tle', '$dateCreated' , '$dateUpdated')";
                            $run_student_final_ratings_epp_tle = mysqli_query($conn,$insert_student_final_ratings_epp_tle);
                            ...
                            $insert_student_final_ratings_mapeh = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                            VALUES ('$lrn', '$mapeh','$phase6_final_rating_mapeh', '$phase6_term5', '$phase6', '$phase6_final_rating_mapeh', '$dateCreated' , '$dateUpdated')";
                            $run_student_final_ratings_mapeh = mysqli_query($conn,$insert_student_final_ratings_mapeh);
                            ...
                            $insert_student_final_ratings_music = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                            VALUES ('$lrn', '$music','$phase6_final_rating_music', '$phase6_term5', '$phase6', '$phase6_final_rating_music', '$dateCreated' , '$dateUpdated')";
                            $run_student_final_ratings_music = mysqli_query($conn,$insert_student_final_ratings_music);
                            ...
                            $insert_student_final_ratings_arts = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                            VALUES ('$lrn', '$arts','$phase6_final_rating_arts', '$phase6_term5', '$phase6', '$phase6_final_rating_arts', '$dateCreated' , '$dateUpdated')";
                            $run_student_final_ratings_arts = mysqli_query($conn,$insert_student_final_ratings_arts);
                            ...
                            $insert_student_final_ratings_pe = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                            VALUES ('$lrn', '$PE','$phase6_final_rating_PE', '$phase6_term5', '$phase6', '$phase6_final_rating_PE', '$dateCreated' , '$dateUpdated')";
                            $run_student_final_ratings_pe = mysqli_query($conn,$insert_student_final_ratings_pe);
                            ...
                            $insert_student_final_ratings_health = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                            VALUES ('$lrn', '$health','$phase6_final_rating_health', '$phase6_term5', '$phase6', '$phase6_final_rating_health', '$dateCreated' , '$dateUpdated')";
                            $run_student_final_ratings_health = mysqli_query($conn,$insert_student_final_ratings_health);
                            ...
                            $insert_student_final_ratings_esp = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                            VALUES ('$lrn', '$esp', '$phase6_final_rating_esp','$phase6_term5', '$phase6', '$phase6_final_rating_esp', '$dateCreated' , '$dateUpdated')";
                            $run_student_final_ratings_esp = mysqli_query($conn,$insert_student_final_ratings_esp);
                            ...
                            $insert_student_final_ratings_arabic = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                            VALUES ('$lrn', '$arabic_language','$phase6_final_rating_arabic_language', '$phase6_term5', '$phase6', '$phase6_final_rating_arabic_language', '$dateCreated' , '$dateUpdated')";
                            $run_student_final_ratings_arabic = mysqli_query($conn,$insert_student_final_ratings_arabic);
                            ...
                            $insert_student_final_ratings_arabic = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                            VALUES ('$lrn', '$islamic_values','$phase6_final_rating_islamic_values', '$phase6_term5', '$phase6', '$phase6_final_rating_islamic_values_outpu', '$dateCreated' , '$dateUpdated')";
                            $run_student_final_ratings_arabic = mysqli_query($conn,$insert_student_final_ratings_arabic);
                            ...
                            if($run_student_final_ratings_arabic){
                                ...
                                //general averag of phase 1 term 5 
                            $insert_phase6_term5_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase6_term5_general_average', '$term1_phase6','$term1_phase6_remarks', '$dateCreated','$dateUpdated')";
                            ...
                            if($phase7_run_scholastic_records){
                                ...
                                if($run_student_grades_term1_phase7_islamic){
                                     echo  "added term islamic" . '<br>';
                                      ...
                                      echo "error term1_phase7 islamic" . '<br>';
                                        ...
                                        //general average
                                    $insert_phase7_term1_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn', '$phase7_term1_general_average', '$term1_phase7','$phase7_remarks','$dateCreated', '$dateUpdated')";
                                ...
                                VALUES ('$lrn', '$mother_tongue','$term1_phase7_mother_tongue', '$term2_phase7', '$term2_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term2_phase7_mother_tongue = mysqli_query($conn,$insert_student_grades_term2_phase7_mother_tongue);
                                if($run_student_grades_term2_phase7_mother_tongue){
                                echo "added insert_student_grades_term2_phase7_mother_tongue ";
                                }else{
                                echo "error insert_student_grades_term2_phase7_mother_tongue". $conn->error;
                                }
                                ...
                                VALUES ('$lrn', '$filipino','$term2_phase7_filipino', '$term2_phase7', '$term2_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term2_phase7_filipino = mysqli_query($conn,$insert_student_grades_term2_phase7_filipino);
                                if($run_student_grades_term2_phase7_filipino){
                                echo "added insert_student_grades_term2_phase7_filipino ";
                                }else{
                                echo "error insert_student_grades_term2_phase7_filipino". $conn->error;
                                }
                                ...
                                VALUES ('$lrn', '$english','$term2_phase7_english', '$term2_phase7', '$term2_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term2_phase7_english = mysqli_query($conn,$insert_student_grades_term2_phase7_english);
                                if($run_student_grades_term2_phase7_english){
                                echo "added insert_student_grades_term2_phase7_english ";
                                }else{
                                echo "error insert_student_grades_term2_phase7_english". $conn->error;
                                }
                                
                                //insert term2 phase 1 math
                                $insert_student_grades_term2_phase7_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$math','$term2_phase7_mathematics', '$term2_phase7', '$term2_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term2_phase7_mathematics = mysqli_query($conn,$insert_student_grades_term2_phase7_mathematics);
                                if($run_student_grades_term2_phase7_mathematics){
                                echo "added insert_student_grades_term1_phase7_mathematics ";
                                }else{
                                echo "error insert_student_grades_term1_phase7_mathematics". $conn->error;
                                }
                                ...
                                VALUES ('$lrn', '$science','$term2_phase7_science', '$term2_phase7', '$term2_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term2_phase7_science = mysqli_query($conn,$insert_student_grades_term2_phase7_science);
                                if($run_student_grades_term2_phase7_science){
                                echo "added insert_student_grades_term2_phase7_science ";
                                }else{
                                echo "error insert_student_grades_term2_phase7_science". $conn->error;
                                }
                                ...
                                VALUES ('$lrn', '$AP','$term2_phase7_araling_panlipunan', '$term2_phase7', '$term2_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term2_phase7_AP = mysqli_query($conn,$insert_student_grades_term2_phase7_AP);
                                if($run_student_grades_term2_phase7_AP){
                                echo "added insert_student_grades_term2_phase7_AP ";
                                }else{
                                echo "error insert_student_grades_term2_phase7_AP". $conn->error;
                                }
                                ...
                                VALUES ('$lrn', '$epp_tle','$term2_phase7_epp_tle', '$term2_phase7', '$term2_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term2_phase7_epp_tle = mysqli_query($conn,$insert_student_grades_term2_phase7_epp_tle);
                                if($run_student_grades_term2_phase7_epp_tle){
                                echo "added insert_student_grades_term2_phase7_epp_tle ";
                                }else{
                                echo "error insert_student_grades_term2_phase7_epp_tle". $conn->error;
                                }
                                
                                //insert term2 phase 1 mapeh
                                $insert_term2_phase7_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$mapeh','$term2_phase7_average_of_mapeh', '$term2_phase7', '$term2_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term2_phase7_mapeh = mysqli_query($conn,$run_student_grades_term2_phase7_mapeh);
                                if($run_student_grades_term2_phase7_epp_tle){
                                echo "added insert_term2_phase7_average_of_mapeh ";
                                }else{
                                echo "error insert_term2_phase7_average_of_mapeh". $conn->error;
                                }
                                
                                
                                //insert term2 phase 1 mapeh
                                $insert_term2_phase7_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$music','$term2_phase7_music', '$term2_phase7', '$term2_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term2_phase7_music = mysqli_query($conn,$insert_term2_phase7_music);
                                if($run_student_grades_term2_phase7_music){
                                echo "added insert_term2_phase7_music ";
                                }else{
                                echo "error insert_term2_phase7_music". $conn->error;
                                }
                                
                                //insert term2 phase 1 arts
                                $insert_term2_phase7_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$arts','$term2_phase7_arts', '$term2_phase7', '$term2_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term2_phase7_arts = mysqli_query($conn,$insert_term2_phase7_arts);
                                if($run_student_grades_term2_phase7_arts){
                                echo "added insert_term2_phase7_arts ";
                                }else{
                                echo "error insert_term2_phase7_arts". $conn->error;
                                }
                                
                                //insert term2 phase 1 PE
                                $insert_term2_phase7_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$PE','$term2_phase7_pe', '$term2_phase7', '$term2_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term2_phase7_pe = mysqli_query($conn,$insert_term2_phase7_PE);
                                if($run_student_grades_term2_phase7_pe){
                                echo "added insert_term2_phase7_PE ";
                                }else{
                                echo "error insert_term2_phase7_PE". 
                                $conn->error;
                                }
                                
                                $insert_term2_phase7_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$health','$term2_phase7_health', '$term2_phase7', '$term2_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term2_phase7_health = mysqli_query($conn,$insert_term2_phase7_health);
                                if($run_student_grades_term2_phase7_health){
                                echo"added insert_term2_phase7_health";
                                }
                                else{
                                echo"error term2 phase 1 health". $conn->error; 
                                }
                                ...
                                if($run_student_grades_term2_phase7_islamic){
                                     echo  "added term islamic" . '<br>';
                                      ...
                                      echo "error term2_phase7 islamic" . '<br>';
                                        ...
                                        // general average of term 2
                                $insert_phase7_term2_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase7_term2_general_average', '$term1_phase7','$term1_phase7_remarks', '$dateCreated','$dateUpdated')";
                                $run_phase7_term2_general_average = mysqli_query($conn,$insert_phase7_term2_general_average);
                                
                                 if($run_phase7_term2_general_average){
                                            echo "added student averages term2";
                                 }else{
                                      echo "error student averages term2";
                                     }
                                ...
                                VALUES ('$lrn', '$mother_tongue','$term1_phase7_mother_tongue', '$term3_phase7', '$term3_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term3_phase7_mother_tongue = mysqli_query($conn,$insert_student_grades_term3_phase7_mother_tongue);
                                if($run_student_grades_3_phase7_mother_tongue){
                                echo "added insert_student_grades_term3_phase7_mother_tongue ";
                                }else{
                                echo "error insert_student_grades_term3_phase7_mother_tongue". $conn->error;
                                }
                                ...
                                VALUES ('$lrn', '$filipino','$term3_phase7_filipino', '$term3_phase7', '$term3_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term3_phase7_filipino = mysqli_query($conn,$insert_student_grades_term3_phase7_filipino);
                                if($run_student_grades_term3_phase7_filipino){
                                echo "added insert_student_grades_term3_phase7_filipino ";
                                }else{
                                echo "error insert_student_grades_term3_phase7_filipino". $conn->error;
                                }
                                ...
                                VALUES ('$lrn', '$english','$term3_phase7_english', '$term3_phase7', '$term3_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term3_phase7_english = mysqli_query($conn,$insert_student_grades_term3_phase7_english);
                                if($run_student_grades_term3_phase7_english){
                                echo "added insert_student_grades_term3_phase7_english ";
                                }else{
                                echo "error insert_student_grades_term3_phase7_english". $conn->error;
                                }
                                
                                //insert term3 phase 1 math
                                $insert_student_grades_term3_phase7_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$math','$term3_phase7_mathematics', '$term3_phase7', '$term3_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term3_phase7_mathematics = mysqli_query($conn,$insert_student_grades_term3_phase7_mathematics);
                                if($run_student_grades_term3_phase7_mathematics){
                                echo "added insert_student_grades_term3_phase7_mathematics ";
                                }else{
                                echo "error insert_student_grades_term3_phase7_mathematics". $conn->error;
                                }
                                ...
                                VALUES ('$lrn', '$science','$term3_phase7_science', '$term3_phase7', '$term3_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term3_phase7_science = mysqli_query($conn,$insert_student_grades_term3_phase7_science);
                                if($run_student_grades_term3_phase7_science){
                                echo "added insert_student_grades_term3_phase7_science ";
                                }else{
                                echo "error insert_student_grades_term3_phase7_science". $conn->error;
                                }
                                ...
                                VALUES ('$lrn', '$AP','$term3_phase7_araling_panlipunan', '$term3_phase7', '$term3_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term3_phase7_AP = mysqli_query($conn,$insert_student_grades_term3_phase7_AP);
                                if($run_student_grades_term3_phase7_AP){
                                echo "added insert_student_grades_term3_phase7_AP ";
                                }else{
                                echo "error insert_student_grades_term3_phase7_AP". $conn->error;
                                }
                                ...
                                VALUES ('$lrn', '$epp_tle','$term3_phase7_epp_tle', '$term3_phase7', '$term3_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term3_phase7_epp_tle = mysqli_query($conn,$insert_student_grades_term3_phase7_epp_tle);
                                if($run_student_grades_term3_phase7_epp_tle){
                                echo "added insert_student_grades_term3_phase7_epp_tle ";
                                }else{
                                echo "error insert_student_grades_term3_phase7_epp_tle". $conn->error;
                                }
                                
                                //insert term3 phase 1 mapeh
                                $insert_term3_phase7_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$mapeh','$term3_phase7_average_of_mapeh', '$term3_phase7', '$term3_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term3_phase7_mapeh = mysqli_query($conn,$run_student_grades_term3_phase7_mapeh);
                                if($run_student_grades_term3_phase7_epp_tle){
                                echo "added insert_term3_phase7_average_of_mapeh ";
                                }else{
                                echo "error insert_term3_phase7_average_of_mapeh". $conn->error;
                                }
                                
                                
                                //insert term3 phase 1 mapeh
                                $insert_term3_phase7_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$music','$term3_phase7_music', '$term3_phase7', '$term3_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term3_phase7_music = mysqli_query($conn,$insert_term3_phase7_music);
                                if($run_student_grades_term3_phase7_music){
                                echo "added insert_term3_phase7_music ";
                                }else{
                                echo "error insert_term3_phase7_music". $conn->error;
                                }
                                
                                //insert term3 phase 1 arts
                                $insert_term3_phase7_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$arts','$term3_phase7_arts', '$term3_phase7', '$term3_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term3_phase7_arts = mysqli_query($conn,$insert_term3_phase7_arts);
                                if($run_student_grades_term3_phase7_arts){
                                echo "added insert_term3_phase7_arts ";
                                }else{
                                echo "error insert_term3_phase7_arts". $conn->error;
                                }
                                
                                //insert term3 phase 1 PE
                                $insert_term3_phase7_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$PE','$term3_phase7_pe', '$term3_phase7', '$term3_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term3_phase7_pe = mysqli_query($conn,$insert_term3_phase7_PE);
                                if($run_student_grades_term3_phase7_pe){
                                echo "added insert_term3_phase7_PE ";
                                }else{
                                echo "error insert_term3_phase7_PE". 
                                $conn->error;
                                }
                                
                                $insert_term3_phase7_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$health','$term3_phase7_health', '$term3_phase7', '$term3_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term3_phase7_health = mysqli_query($conn,$insert_term3_phase7_health);
                                if($run_student_grades_term3_phase7_health){
                                echo"added insert_term3_phase7_health";
                                }
                                else{
                                echo"error term3 phase 1 health". $conn->error; 
                                }
                                ...
                                $insert_phase7_term3_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase7_term3_general_average', '$term1_phase7','$term1_phase7_remarks', '$dateCreated','$dateUpdated')";
                                $run_phase7_term3_general_average = mysqli_query($conn,$insert_phase7_term3_general_average);
                                
                                if($run_phase7_term3_general_average){
                                echo "added student averages term3";
                                }else{
                                echo "added student averages term3";
                                }
                                ...
                                VALUES ('$lrn', '$mother_tongue','$term1_phase7_mother_tongue', '$term4_phase7', '$term4_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term4_phase7_mother_tongue = mysqli_query($conn,$insert_student_grades_term4_phase7_mother_tongue);
                                if($run_student_grades_4_phase7_mother_tongue){
                                        echo "added insert_student_grades_term4_phase7_mother_tongue ";
                                    }else{
                                        echo "error insert_student_grades_term4_phase7_mother_tongue". $conn->error;
                                    }
                                ...
                                VALUES ('$lrn', '$filipino','$term4_phase7_filipino', '$term4_phase7', '$term4_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term4_phase7_filipino = mysqli_query($conn,$insert_student_grades_term4_phase7_filipino);
                                if($run_student_grades_term4_phase7_filipino){
                                     echo "added insert_student_grades_term4_phase7_filipino ";
                                    }
                                    else{
                                     echo "error insert_student_grades_term4_phase7_filipino". $conn->error;
                                    }
                                ...
                                VALUES ('$lrn', '$english','$term4_phase7_english', '$term4_phase7', '$term4_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term4_phase7_english = mysqli_query($conn,$insert_student_grades_term4_phase7_english);
                                if($run_student_grades_term4_phase7_english){
                                echo "added insert_student_grades_term4_phase7_english ";
                                    }
                                else{
                                    echo "error insert_student_grades_term4_phase7_english". $conn->error;
                                    }
                                
                                //insert term4 phase 1 math
                                $insert_student_grades_term4_phase7_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$math','$term4_phase7_mathematics', '$term4_phase7', '$term4_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term4_phase7_mathematics = mysqli_query($conn,$insert_student_grades_term4_phase7_mathematics);
                                if($run_student_grades_term4_phase7_mathematics){
                                echo "added insert_student_grades_term4_phase7_mathematics ";
                                    }
                                else{
                                     echo "error insert_student_grades_term4_phase7_mathematics". $conn->error;
                                    }
                                ...
                                VALUES ('$lrn', '$science','$term4_phase7_science', '$term4_phase7', '$term4_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term4_phase7_science = mysqli_query($conn,$insert_student_grades_term4_phase7_science);
                                if($run_student_grades_term4_phase7_science){
                                     echo "added insert_student_grades_term4_phase7_science ";
                                    }
                                    else{
                                    echo "error insert_student_grades_term4_phase7_science". $conn->error;
                                    }
                                ...
                                VALUES ('$lrn', '$AP','$term4_phase7_araling_panlipunan', '$term4_phase7', '$term4_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term4_phase7_AP = mysqli_query($conn,$insert_student_grades_term4_phase7_AP);
                                if($run_student_grades_term4_phase7_AP){
                                     echo "added insert_student_grades_term4_phase7_AP ";
                                    }
                                else{
                                      echo "error insert_student_grades_term4_phase7_AP". $conn->error;
                                 }
                                ...
                                VALUES ('$lrn', '$epp_tle','$term4_phase7_epp_tle', '$term4_phase7', '$term4_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term4_phase7_epp_tle = mysqli_query($conn,$insert_student_grades_term4_phase7_epp_tle);
                                if($run_student_grades_term4_phase7_epp_tle){
                                    echo "added insert_student_grades_term4_phase7_epp_tle ";
                                    }
                                else{
                                  echo "error insert_student_grades_term4_phase7_epp_tle". $conn->error;
                                    }
                                
                                //insert term4 phase 1 mapeh
                                $insert_term4_phase7_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$mapeh','$term4_phase7_average_of_mapeh', '$term4_phase7', '$term4_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term4_phase7_mapeh = mysqli_query($conn,$run_student_grades_term4_phase7_mapeh);
                                if($run_student_grades_term4_phase7_epp_tle){
                                echo "added insert_term4_phase7_average_of_mapeh ";
                                }
                                else{
                                 echo "error insert_term4_phase7_average_of_mapeh". $conn->error;
                                    }
                                
                                    
                                //insert term4 phase 1 mapeh
                                $insert_term4_phase7_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$music','$term4_phase7_music', '$term4_phase7', '$term4_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term4_phase7_music = mysqli_query($conn,$insert_term4_phase7_music);
                                if($run_student_grades_term4_phase7_music){
                                     echo "added insert_term4_phase7_music ";
                                  }
                                  else{
                                     echo "error insert_term4_phase7_music". $conn->error;
                                    }
                                
                                //insert term4 phase 1 arts
                                $insert_term4_phase7_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$arts','$term4_phase7_arts', '$term4_phase7', '$term4_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term4_phase7_arts = mysqli_query($conn,$insert_term4_phase7_arts);
                                if($run_student_grades_term4_phase7_arts){
                                echo "added insert_term4_phase7_arts ";
                                }else{
                                echo "error insert_term4_phase7_arts". $conn->error;
                                }
                                
                                //insert term4 phase 1 PE
                                $insert_term4_phase7_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$PE','$term4_phase7_pe', '$term4_phase7', '$term4_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term4_phase7_pe = mysqli_query($conn,$insert_term4_phase7_PE);
                                if($run_student_grades_term4_phase7_pe){
                                echo "added insert_term4_phase7_PE ";
                                }else{
                                echo "error insert_term4_phase7_PE". 
                                $conn->error;
                                }
                                
                                $insert_term4_phase7_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                                VALUES ('$lrn', '$health','$term4_phase7_health', '$term4_phase7', '$term4_phase7_remarks','$dateCreated', '$dateUpdated')";
                                $run_student_grades_term4_phase7_health = mysqli_query($conn,$insert_term4_phase7_health);
                                if($run_student_grades_term4_phase7_health){
                                echo"added insert_term4_phase7_health";
                                }
                                else{
                                echo"error term4 phase 1 health". $conn->error; 
                                }
                                ...
                                if($run_student_grades_term4_phase7_islamic){
                                     echo  "added term islamic" . '<br>';
                                      ...
                                      echo "error term4_phase7 islamic" . '<br>';
                                        ...
                                        // general average of phase 1 term 4 
                                    $insert_phase7_term4_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase7_term4_general_average', '$term1_phase7','$term1_phase7_remarks', '$dateCreated','$dateUpdated')";
                                $run_phase7_term4_general_average = mysqli_query($conn,$insert_phase7_term4_general_average);
                                
                                if($run_phase7_term4_general_average){
                                    echo "added student averages term4";
                                }else{
                                    echo "added student averages term4";
                                }
                                ...
                                $insert_student_final_ratings_english = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                                VALUES ('$lrn', '$english','$phase7_final_rating_english', '$phase7_term5', '$phase7', '$phase7_final_rating_english', '$dateCreated' , '$dateUpdated')";
                                $run_student_final_ratings_english = mysqli_query($conn,$insert_student_final_ratings_english);
                                ...
                                $insert_student_final_ratings_math = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                                VALUES ('$lrn', '$math','$phase7_final_rating_math', '$phase7_term5', '$phase7', '$phase7_final_rating_math', '$dateCreated' , '$dateUpdated')";
                                $run_student_final_ratings_math = mysqli_query($conn,$insert_student_final_ratings_math);
                                ...
                                $insert_student_final_ratings_science = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                                VALUES ('$lrn', '$science','$phase7_final_rating_science', '$phase7_term5', '$phase7', '$phase7_final_rating_science', '$dateCreated' , '$dateUpdated')";
                                $run_student_final_ratings_science = mysqli_query($conn,$insert_student_final_ratings_science);
                                ...
                                $insert_student_final_ratings_AP = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                                VALUES ('$lrn', '$AP','$phase7_final_rating_AP', '$phase7_term5', '$phase7', '$phase7_final_rating_AP', '$dateCreated' , '$dateUpdated')";
                                $run_student_final_ratings_AP = mysqli_query($conn,$insert_student_final_ratings_AP);
                                ...
                                $insert_student_final_ratings_epp_tle = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                                VALUES ('$lrn', '$epp_tle','$phase7_final_rating_epp_tle', '$phase7_term5', '$phase7', '$phase7_final_rating_epp_tle', '$dateCreated' , '$dateUpdated')";
                                $run_student_final_ratings_epp_tle = mysqli_query($conn,$insert_student_final_ratings_epp_tle);
                                ...
                                $insert_student_final_ratings_mapeh = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                                VALUES ('$lrn', '$mapeh','$phase7_final_rating_mapeh', '$phase7_term5', '$phase7', '$phase7_final_rating_mapeh', '$dateCreated' , '$dateUpdated')";
                                $run_student_final_ratings_mapeh = mysqli_query($conn,$insert_student_final_ratings_mapeh);
                                ...
                                $insert_student_final_ratings_music = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                                VALUES ('$lrn', '$music','$phase7_final_rating_music', '$phase7_term5', '$phase7', '$phase7_final_rating_music', '$dateCreated' , '$dateUpdated')";
                                $run_student_final_ratings_music = mysqli_query($conn,$insert_student_final_ratings_music);
                                ...
                                $insert_student_final_ratings_arts = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                                VALUES ('$lrn', '$arts','$phase7_final_rating_arts', '$phase7_term5', '$phase7', '$phase7_final_rating_arts', '$dateCreated' , '$dateUpdated')";
                                $run_student_final_ratings_arts = mysqli_query($conn,$insert_student_final_ratings_arts);
                                ...
                                $insert_student_final_ratings_pe = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                                VALUES ('$lrn', '$PE','$phase7_final_rating_PE', '$phase7_term5', '$phase7', '$phase7_final_rating_PE', '$dateCreated' , '$dateUpdated')";
                                $run_student_final_ratings_pe = mysqli_query($conn,$insert_student_final_ratings_pe);
                                ...
                                $insert_student_final_ratings_health = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                                VALUES ('$lrn', '$health','$phase7_final_rating_health', '$phase7_term5', '$phase7', '$phase7_final_rating_health', '$dateCreated' , '$dateUpdated')";
                                $run_student_final_ratings_health = mysqli_query($conn,$insert_student_final_ratings_health);
                                ...
                                $insert_student_final_ratings_esp = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                                VALUES ('$lrn', '$esp', '$phase7_final_rating_esp','$phase7_term5', '$phase7', '$phase7_final_rating_esp', '$dateCreated' , '$dateUpdated')";
                                $run_student_final_ratings_esp = mysqli_query($conn,$insert_student_final_ratings_esp);
                                ...
                                $insert_student_final_ratings_arabic = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                                VALUES ('$lrn', '$arabic_language','$phase7_final_rating_arabic_language', '$phase7_term5', '$phase7', '$phase7_final_rating_arabic_language', '$dateCreated' , '$dateUpdated')";
                                $run_student_final_ratings_arabic = mysqli_query($conn,$insert_student_final_ratings_arabic);
                                ...
                                $insert_student_final_ratings_arabic = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                                VALUES ('$lrn', '$islamic_values','$phase7_final_rating_islamic_values', '$phase7_term5', '$phase7', '$phase7_final_rating_islamic_values_outpu', '$dateCreated' , '$dateUpdated')";
                                $run_student_final_ratings_arabic = mysqli_query($conn,$insert_student_final_ratings_arabic);
                                ...
                                if($run_student_final_ratings_arabic){
                                    ...
                                    //general averag of phase 1 term 5 
                                $insert_phase7_term5_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase7_term5_general_average', '$term1_phase7','$term1_phase7_remarks', '$dateCreated','$dateUpdated')";
            ...
            if($phase8_run_scholastic_records){
                ...
                if($run_student_grades_term1_phase8_islamic){
                     echo  "added term islamic" . '<br>';
                      ...
                      echo "error term1_phase8 islamic" . '<br>';
                        ...
                        //general average
                    $insert_phase8_term1_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn', '$phase8_term1_general_average', '$term1_phase8','$phase8_remarks','$dateCreated', '$dateUpdated')";
                ...
                VALUES ('$lrn', '$mother_tongue','$term1_phase8_mother_tongue', '$term2_phase8', '$term2_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase8_mother_tongue = mysqli_query($conn,$insert_student_grades_term2_phase8_mother_tongue);
                if($run_student_grades_term2_phase8_mother_tongue){
                echo "added insert_student_grades_term2_phase8_mother_tongue ";
                }else{
                echo "error insert_student_grades_term2_phase8_mother_tongue". $conn->error;
                }
                ...
                VALUES ('$lrn', '$filipino','$term2_phase8_filipino', '$term2_phase8', '$term2_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase8_filipino = mysqli_query($conn,$insert_student_grades_term2_phase8_filipino);
                if($run_student_grades_term2_phase8_filipino){
                echo "added insert_student_grades_term2_phase8_filipino ";
                }else{
                echo "error insert_student_grades_term2_phase8_filipino". $conn->error;
                }
                ...
                VALUES ('$lrn', '$english','$term2_phase8_english', '$term2_phase8', '$term2_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase8_english = mysqli_query($conn,$insert_student_grades_term2_phase8_english);
                if($run_student_grades_term2_phase8_english){
                echo "added insert_student_grades_term2_phase8_english ";
                }else{
                echo "error insert_student_grades_term2_phase8_english". $conn->error;
                }
                
                //insert term2 phase 1 math
                $insert_student_grades_term2_phase8_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$math','$term2_phase8_mathematics', '$term2_phase8', '$term2_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase8_mathematics = mysqli_query($conn,$insert_student_grades_term2_phase8_mathematics);
                if($run_student_grades_term2_phase8_mathematics){
                echo "added insert_student_grades_term1_phase8_mathematics ";
                }else{
                echo "error insert_student_grades_term1_phase8_mathematics". $conn->error;
                }
                ...
                VALUES ('$lrn', '$science','$term2_phase8_science', '$term2_phase8', '$term2_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase8_science = mysqli_query($conn,$insert_student_grades_term2_phase8_science);
                if($run_student_grades_term2_phase8_science){
                echo "added insert_student_grades_term2_phase8_science ";
                }else{
                echo "error insert_student_grades_term2_phase8_science". $conn->error;
                }
                ...
                VALUES ('$lrn', '$AP','$term2_phase8_araling_panlipunan', '$term2_phase8', '$term2_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase8_AP = mysqli_query($conn,$insert_student_grades_term2_phase8_AP);
                if($run_student_grades_term2_phase8_AP){
                echo "added insert_student_grades_term2_phase8_AP ";
                }else{
                echo "error insert_student_grades_term2_phase8_AP". $conn->error;
                }
                ...
                VALUES ('$lrn', '$epp_tle','$term2_phase8_epp_tle', '$term2_phase8', '$term2_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase8_epp_tle = mysqli_query($conn,$insert_student_grades_term2_phase8_epp_tle);
                if($run_student_grades_term2_phase8_epp_tle){
                echo "added insert_student_grades_term2_phase8_epp_tle ";
                }else{
                echo "error insert_student_grades_term2_phase8_epp_tle". $conn->error;
                }
                
                //insert term2 phase 1 mapeh
                $insert_term2_phase8_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$mapeh','$term2_phase8_average_of_mapeh', '$term2_phase8', '$term2_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase8_mapeh = mysqli_query($conn,$run_student_grades_term2_phase8_mapeh);
                if($run_student_grades_term2_phase8_epp_tle){
                echo "added insert_term2_phase8_average_of_mapeh ";
                }else{
                echo "error insert_term2_phase8_average_of_mapeh". $conn->error;
                }
                
                
                //insert term2 phase 1 mapeh
                $insert_term2_phase8_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$music','$term2_phase8_music', '$term2_phase8', '$term2_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase8_music = mysqli_query($conn,$insert_term2_phase8_music);
                if($run_student_grades_term2_phase8_music){
                echo "added insert_term2_phase8_music ";
                }else{
                echo "error insert_term2_phase8_music". $conn->error;
                }
                
                //insert term2 phase 1 arts
                $insert_term2_phase8_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$arts','$term2_phase8_arts', '$term2_phase8', '$term2_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase8_arts = mysqli_query($conn,$insert_term2_phase8_arts);
                if($run_student_grades_term2_phase8_arts){
                echo "added insert_term2_phase8_arts ";
                }else{
                echo "error insert_term2_phase8_arts". $conn->error;
                }
                
                //insert term2 phase 1 PE
                $insert_term2_phase8_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$PE','$term2_phase8_pe', '$term2_phase8', '$term2_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase8_pe = mysqli_query($conn,$insert_term2_phase8_PE);
                if($run_student_grades_term2_phase8_pe){
                echo "added insert_term2_phase8_PE ";
                }else{
                echo "error insert_term2_phase8_PE". 
                $conn->error;
                }
                
                $insert_term2_phase8_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$health','$term2_phase8_health', '$term2_phase8', '$term2_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term2_phase8_health = mysqli_query($conn,$insert_term2_phase8_health);
                if($run_student_grades_term2_phase8_health){
                echo"added insert_term2_phase8_health";
                }
                else{
                echo"error term2 phase 1 health". $conn->error; 
                }
                ...
                if($run_student_grades_term2_phase8_islamic){
                     echo  "added term islamic" . '<br>';
                      ...
                      echo "error term2_phase8 islamic" . '<br>';
                        ...
                        // general average of term 2
                $insert_phase8_term2_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase8_term2_general_average', '$term1_phase8','$term1_phase8_remarks', '$dateCreated','$dateUpdated')";
                $run_phase8_term2_general_average = mysqli_query($conn,$insert_phase8_term2_general_average);
                
                 if($run_phase8_term2_general_average){
                            echo "added student averages term2";
                 }else{
                      echo "error student averages term2";
                     }
                ...
                VALUES ('$lrn', '$mother_tongue','$term1_phase8_mother_tongue', '$term3_phase8', '$term3_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase8_mother_tongue = mysqli_query($conn,$insert_student_grades_term3_phase8_mother_tongue);
                if($run_student_grades_3_phase8_mother_tongue){
                echo "added insert_student_grades_term3_phase8_mother_tongue ";
                }else{
                echo "error insert_student_grades_term3_phase8_mother_tongue". $conn->error;
                }
                ...
                VALUES ('$lrn', '$filipino','$term3_phase8_filipino', '$term3_phase8', '$term3_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase8_filipino = mysqli_query($conn,$insert_student_grades_term3_phase8_filipino);
                if($run_student_grades_term3_phase8_filipino){
                echo "added insert_student_grades_term3_phase8_filipino ";
                }else{
                echo "error insert_student_grades_term3_phase8_filipino". $conn->error;
                }
                ...
                VALUES ('$lrn', '$english','$term3_phase8_english', '$term3_phase8', '$term3_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase8_english = mysqli_query($conn,$insert_student_grades_term3_phase8_english);
                if($run_student_grades_term3_phase8_english){
                echo "added insert_student_grades_term3_phase8_english ";
                }else{
                echo "error insert_student_grades_term3_phase8_english". $conn->error;
                }
                
                //insert term3 phase 1 math
                $insert_student_grades_term3_phase8_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$math','$term3_phase8_mathematics', '$term3_phase8', '$term3_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase8_mathematics = mysqli_query($conn,$insert_student_grades_term3_phase8_mathematics);
                if($run_student_grades_term3_phase8_mathematics){
                echo "added insert_student_grades_term3_phase8_mathematics ";
                }else{
                echo "error insert_student_grades_term3_phase8_mathematics". $conn->error;
                }
                ...
                VALUES ('$lrn', '$science','$term3_phase8_science', '$term3_phase8', '$term3_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase8_science = mysqli_query($conn,$insert_student_grades_term3_phase8_science);
                if($run_student_grades_term3_phase8_science){
                echo "added insert_student_grades_term3_phase8_science ";
                }else{
                echo "error insert_student_grades_term3_phase8_science". $conn->error;
                }
                ...
                VALUES ('$lrn', '$AP','$term3_phase8_araling_panlipunan', '$term3_phase8', '$term3_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase8_AP = mysqli_query($conn,$insert_student_grades_term3_phase8_AP);
                if($run_student_grades_term3_phase8_AP){
                echo "added insert_student_grades_term3_phase8_AP ";
                }else{
                echo "error insert_student_grades_term3_phase8_AP". $conn->error;
                }
                ...
                VALUES ('$lrn', '$epp_tle','$term3_phase8_epp_tle', '$term3_phase8', '$term3_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase8_epp_tle = mysqli_query($conn,$insert_student_grades_term3_phase8_epp_tle);
                if($run_student_grades_term3_phase8_epp_tle){
                echo "added insert_student_grades_term3_phase8_epp_tle ";
                }else{
                echo "error insert_student_grades_term3_phase8_epp_tle". $conn->error;
                }
                
                //insert term3 phase 1 mapeh
                $insert_term3_phase8_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$mapeh','$term3_phase8_average_of_mapeh', '$term3_phase8', '$term3_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase8_mapeh = mysqli_query($conn,$run_student_grades_term3_phase8_mapeh);
                if($run_student_grades_term3_phase8_epp_tle){
                echo "added insert_term3_phase8_average_of_mapeh ";
                }else{
                echo "error insert_term3_phase8_average_of_mapeh". $conn->error;
                }
                
                
                //insert term3 phase 1 mapeh
                $insert_term3_phase8_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$music','$term3_phase8_music', '$term3_phase8', '$term3_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase8_music = mysqli_query($conn,$insert_term3_phase8_music);
                if($run_student_grades_term3_phase8_music){
                echo "added insert_term3_phase8_music ";
                }else{
                echo "error insert_term3_phase8_music". $conn->error;
                }
                
                //insert term3 phase 1 arts
                $insert_term3_phase8_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$arts','$term3_phase8_arts', '$term3_phase8', '$term3_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase8_arts = mysqli_query($conn,$insert_term3_phase8_arts);
                if($run_student_grades_term3_phase8_arts){
                echo "added insert_term3_phase8_arts ";
                }else{
                echo "error insert_term3_phase8_arts". $conn->error;
                }
                
                //insert term3 phase 1 PE
                $insert_term3_phase8_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$PE','$term3_phase8_pe', '$term3_phase8', '$term3_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase8_pe = mysqli_query($conn,$insert_term3_phase8_PE);
                if($run_student_grades_term3_phase8_pe){
                echo "added insert_term3_phase8_PE ";
                }else{
                echo "error insert_term3_phase8_PE". 
                $conn->error;
                }
                
                $insert_term3_phase8_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$health','$term3_phase8_health', '$term3_phase8', '$term3_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term3_phase8_health = mysqli_query($conn,$insert_term3_phase8_health);
                if($run_student_grades_term3_phase8_health){
                echo"added insert_term3_phase8_health";
                }
                else{
                echo"error term3 phase 1 health". $conn->error; 
                }
                ...
                $insert_phase8_term3_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase8_term3_general_average', '$term1_phase8','$term1_phase8_remarks', '$dateCreated','$dateUpdated')";
                $run_phase8_term3_general_average = mysqli_query($conn,$insert_phase8_term3_general_average);
                
                if($run_phase8_term3_general_average){
                echo "added student averages term3";
                }else{
                echo "added student averages term3";
                }
                ...
                VALUES ('$lrn', '$mother_tongue','$term1_phase8_mother_tongue', '$term4_phase8', '$term4_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase8_mother_tongue = mysqli_query($conn,$insert_student_grades_term4_phase8_mother_tongue);
                if($run_student_grades_4_phase8_mother_tongue){
                        echo "added insert_student_grades_term4_phase8_mother_tongue ";
                    }else{
                        echo "error insert_student_grades_term4_phase8_mother_tongue". $conn->error;
                    }
                ...
                VALUES ('$lrn', '$filipino','$term4_phase8_filipino', '$term4_phase8', '$term4_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase8_filipino = mysqli_query($conn,$insert_student_grades_term4_phase8_filipino);
                if($run_student_grades_term4_phase8_filipino){
                     echo "added insert_student_grades_term4_phase8_filipino ";
                    }
                    else{
                     echo "error insert_student_grades_term4_phase8_filipino". $conn->error;
                    }
                ...
                VALUES ('$lrn', '$english','$term4_phase8_english', '$term4_phase8', '$term4_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase8_english = mysqli_query($conn,$insert_student_grades_term4_phase8_english);
                if($run_student_grades_term4_phase8_english){
                echo "added insert_student_grades_term4_phase8_english ";
                    }
                else{
                    echo "error insert_student_grades_term4_phase8_english". $conn->error;
                    }
                
                //insert term4 phase 1 math
                $insert_student_grades_term4_phase8_mathematics = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$math','$term4_phase8_mathematics', '$term4_phase8', '$term4_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase8_mathematics = mysqli_query($conn,$insert_student_grades_term4_phase8_mathematics);
                if($run_student_grades_term4_phase8_mathematics){
                echo "added insert_student_grades_term4_phase8_mathematics ";
                    }
                else{
                     echo "error insert_student_grades_term4_phase8_mathematics". $conn->error;
                    }
                ...
                VALUES ('$lrn', '$science','$term4_phase8_science', '$term4_phase8', '$term4_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase8_science = mysqli_query($conn,$insert_student_grades_term4_phase8_science);
                if($run_student_grades_term4_phase8_science){
                     echo "added insert_student_grades_term4_phase8_science ";
                    }
                    else{
                    echo "error insert_student_grades_term4_phase8_science". $conn->error;
                    }
                ...
                VALUES ('$lrn', '$AP','$term4_phase8_araling_panlipunan', '$term4_phase8', '$term4_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase8_AP = mysqli_query($conn,$insert_student_grades_term4_phase8_AP);
                if($run_student_grades_term4_phase8_AP){
                     echo "added insert_student_grades_term4_phase8_AP ";
                    }
                else{
                      echo "error insert_student_grades_term4_phase8_AP". $conn->error;
                 }
                ...
                VALUES ('$lrn', '$epp_tle','$term4_phase8_epp_tle', '$term4_phase8', '$term4_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase8_epp_tle = mysqli_query($conn,$insert_student_grades_term4_phase8_epp_tle);
                if($run_student_grades_term4_phase8_epp_tle){
                    echo "added insert_student_grades_term4_phase8_epp_tle ";
                    }
                else{
                  echo "error insert_student_grades_term4_phase8_epp_tle". $conn->error;
                    }
                
                //insert term4 phase 1 mapeh
                $insert_term4_phase8_average_of_mapeh = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$mapeh','$term4_phase8_average_of_mapeh', '$term4_phase8', '$term4_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase8_mapeh = mysqli_query($conn,$run_student_grades_term4_phase8_mapeh);
                if($run_student_grades_term4_phase8_epp_tle){
                echo "added insert_term4_phase8_average_of_mapeh ";
                }
                else{
                 echo "error insert_term4_phase8_average_of_mapeh". $conn->error;
                    }
                
                    
                //insert term4 phase 1 mapeh
                $insert_term4_phase8_music = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$music','$term4_phase8_music', '$term4_phase8', '$term4_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase8_music = mysqli_query($conn,$insert_term4_phase8_music);
                if($run_student_grades_term4_phase8_music){
                     echo "added insert_term4_phase8_music ";
                  }
                  else{
                     echo "error insert_term4_phase8_music". $conn->error;
                    }
                
                //insert term4 phase 1 arts
                $insert_term4_phase8_arts = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$arts','$term4_phase8_arts', '$term4_phase8', '$term4_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase8_arts = mysqli_query($conn,$insert_term4_phase8_arts);
                if($run_student_grades_term4_phase8_arts){
                echo "added insert_term4_phase8_arts ";
                }else{
                echo "error insert_term4_phase8_arts". $conn->error;
                }
                
                //insert term4 phase 1 PE
                $insert_term4_phase8_PE = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$PE','$term4_phase8_pe', '$term4_phase8', '$term4_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase8_pe = mysqli_query($conn,$insert_term4_phase8_PE);
                if($run_student_grades_term4_phase8_pe){
                echo "added insert_term4_phase8_PE ";
                }else{
                echo "error insert_term4_phase8_PE". 
                $conn->error;
                }
                
                $insert_term4_phase8_health = "INSERT INTO student_grades (lrn,subject_id,grade,term,phase,remarks,date_time_created,date_time_updated) 
                VALUES ('$lrn', '$health','$term4_phase8_health', '$term4_phase8', '$term4_phase8_remarks','$dateCreated', '$dateUpdated')";
                $run_student_grades_term4_phase8_health = mysqli_query($conn,$insert_term4_phase8_health);
                if($run_student_grades_term4_phase8_health){
                echo"added insert_term4_phase8_health";
                }
                else{
                echo"error term4 phase 1 health". $conn->error; 
                }
                ...
                if($run_student_grades_term4_phase8_islamic){
                     echo  "added term islamic" . '<br>';
                      ...
                      echo "error term4_phase8 islamic" . '<br>';
                        ...
                        // general average of phase 1 term 4 
                    $insert_phase8_term4_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase8_term4_general_average', '$term1_phase8','$term1_phase8_remarks', '$dateCreated','$dateUpdated')";
                $run_phase8_term4_general_average = mysqli_query($conn,$insert_phase8_term4_general_average);
                
                if($run_phase8_term4_general_average){
                    echo "added student averages term4";
                }else{
                    echo "added student averages term4";
                }
                ...
                $insert_student_final_ratings_english = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$english','$phase8_final_rating_english', '$phase8_term5', '$phase8', '$phase8_final_rating_english', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_english = mysqli_query($conn,$insert_student_final_ratings_english);
                ...
                $insert_student_final_ratings_math = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$math','$phase8_final_rating_math', '$phase8_term5', '$phase8', '$phase8_final_rating_math', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_math = mysqli_query($conn,$insert_student_final_ratings_math);
                ...
                $insert_student_final_ratings_science = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$science','$phase8_final_rating_science', '$phase8_term5', '$phase8', '$phase8_final_rating_science', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_science = mysqli_query($conn,$insert_student_final_ratings_science);
                ...
                $insert_student_final_ratings_AP = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$AP','$phase8_final_rating_AP', '$phase8_term5', '$phase8', '$phase8_final_rating_AP', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_AP = mysqli_query($conn,$insert_student_final_ratings_AP);
                ...
                $insert_student_final_ratings_epp_tle = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$epp_tle','$phase8_final_rating_epp_tle', '$phase8_term5', '$phase8', '$phase8_final_rating_epp_tle', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_epp_tle = mysqli_query($conn,$insert_student_final_ratings_epp_tle);
                ...
                $insert_student_final_ratings_mapeh = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$mapeh','$phase8_final_rating_mapeh', '$phase8_term5', '$phase8', '$phase8_final_rating_mapeh', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_mapeh = mysqli_query($conn,$insert_student_final_ratings_mapeh);
                ...
                $insert_student_final_ratings_music = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$music','$phase8_final_rating_music', '$phase8_term5', '$phase8', '$phase8_final_rating_music', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_music = mysqli_query($conn,$insert_student_final_ratings_music);
                ...
                $insert_student_final_ratings_arts = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$arts','$phase8_final_rating_arts', '$phase8_term5', '$phase8', '$phase8_final_rating_arts', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_arts = mysqli_query($conn,$insert_student_final_ratings_arts);
                ...
                $insert_student_final_ratings_pe = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$PE','$phase8_final_rating_PE', '$phase8_term5', '$phase8', '$phase8_final_rating_PE', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_pe = mysqli_query($conn,$insert_student_final_ratings_pe);
                ...
                $insert_student_final_ratings_health = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$health','$phase8_final_rating_health', '$phase8_term5', '$phase8', '$phase8_final_rating_health', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_health = mysqli_query($conn,$insert_student_final_ratings_health);
                ...
                $insert_student_final_ratings_esp = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$esp', '$phase8_final_rating_esp','$phase8_term5', '$phase8', '$phase8_final_rating_esp', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_esp = mysqli_query($conn,$insert_student_final_ratings_esp);
                ...
                $insert_student_final_ratings_arabic = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$arabic_language','$phase8_final_rating_arabic_language', '$phase8_term5', '$phase8', '$phase8_final_rating_arabic_language', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_arabic = mysqli_query($conn,$insert_student_final_ratings_arabic);
                ...
                $insert_student_final_ratings_arabic = "INSERT INTO student_final_ratings (lrn,subject_id,final_rating,term,phase,remarks,date_time_created,date_time_updated)
                VALUES ('$lrn', '$islamic_values','$phase8_final_rating_islamic_values', '$phase8_term5', '$phase8', '$phase8_final_rating_islamic_values_outpu', '$dateCreated' , '$dateUpdated')";
                $run_student_final_ratings_arabic = mysqli_query($conn,$insert_student_final_ratings_arabic);
                ...
                if($run_student_final_ratings_arabic){
                    ...
                    //general averag of phase 1 term 5 
                $insert_phase8_term5_general_average = "INSERT INTO student_general_averages(lrn,general_average,term,phase,remarks,date_time_created,date_time_updated) VALUES ('$lrn','$phase8_term5_general_average', '$term1_phase8','$term1_phase8_remarks', '$dateCreated','$dateUpdated')";
